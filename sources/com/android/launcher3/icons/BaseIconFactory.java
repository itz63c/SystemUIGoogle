...
public class BaseIconFactory implements AutoCloseable {
    static final boolean ATLEAST_OREO = (VERSION.SDK_INT >= 26);
    ...
    public BitmapInfo createIconBitmap(Bitmap bitmap) {
        ...
        return BitmapInfo.m4of(bitmap, extractColor(bitmap));
    }
    ...
    public BitmapInfo createBadgedIconBitmap(Drawable drawable, UserHandle userHandle, boolean z, boolean z2, float[] fArr) {
        ...
        if (normalizeAndWrapToAdaptiveIcon instanceof Extender) {
            return ((Extender) normalizeAndWrapToAdaptiveIcon).getExtendedInfo(createIconBitmap, extractColor, this);
        }
        return BitmapInfo.m4of(createIconBitmap, extractColor);
    }
