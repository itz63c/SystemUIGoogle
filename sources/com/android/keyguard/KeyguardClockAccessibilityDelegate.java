...
class KeyguardClockAccessibilityDelegate extends AccessibilityDelegate {
    private final String mFancyColon;

    public KeyguardClockAccessibilityDelegate(Context context) {
        this.mFancyColon = context.getString(C2017R$string.keyguard_fancy_colon);
    }
    ...
    public static boolean isNeeded(Context context) {
        return !TextUtils.isEmpty(context.getString(C2017R$string.keyguard_fancy_colon));
    }
}
