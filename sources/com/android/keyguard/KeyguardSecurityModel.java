...
public class KeyguardSecurityModel {
    ...
    private final boolean mIsPukScreenAvailable = this.mContext.getResources().getBoolean(17891455);
    ...
    public SecurityMode getSecurityMode(int i) {
        ...
        int intValue = ((Integer) DejankUtils.whitelistIpcs((Supplier<T>) new Supplier(i) {
