...
public class SignalDrawable extends DrawableWrapper {
    ...
    public SignalDrawable(Context context) {
        super(context.getDrawable(17302815));
        this.mXPath.set(PathParser.createPathFromPathData(context.getString(17039839)));
        updateScaledXPath();
    ...
    public void draw(Canvas canvas) {
        ...
        if (isInState(3)) {
            ...
            float f9 = (this.mCutoutWidthFraction * width) / 24.0f;
            float f10 = (this.mCutoutHeightFraction * height) / 24.0f;
