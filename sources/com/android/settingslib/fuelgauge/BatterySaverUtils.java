...
public class BatterySaverUtils {
    ...
    private static class Parameters {
        ...
        public Parameters(Context context) {
            ...
            String string = Global.getString(context.getContentResolver(), "low_power_mode_suggestion_params");
    ...
    private static void setBatterySaverConfirmationAcknowledged(Context context) {
        Secure.putIntForUser(context.getContentResolver(), "low_power_warning_acknowledged", 1, -2);
    }
