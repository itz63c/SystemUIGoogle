...
public class Lifecycle extends LifecycleRegistry {
    ...
    static /* synthetic */ class C06311 {
        ...
        static {
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.settingslib.core.lifecycle.Lifecycle.C06311.<clinit>():void");
        }
    }
    ...
    private class LifecycleProxy implements LifecycleObserver {
        ...
        /* synthetic */ LifecycleProxy(Lifecycle lifecycle, C06311 r2) {
            this();
        }

        @OnLifecycleEvent(Event.ON_ANY)
        public void onLifecycleEvent(LifecycleOwner lifecycleOwner, Event event) {
            switch (C06311.$SwitchMap$androidx$lifecycle$Lifecycle$Event[event.ordinal()]) {
                case 2:
