...
public class EnableZenModeDialog {
    ...
    public void bind(Condition condition, View view, int i) {
        ...
        if (condition != null) {
            ...
            if (conditionTag2.f25rb != null) {
                z = false;
            }
            if (conditionTag2.f25rb == null) {
                conditionTag2.f25rb = (RadioButton) this.mZenRadioGroup.getChildAt(i);
            }
            ...
            conditionTag2.f25rb.setEnabled(z2);
            conditionTag2.f25rb.setOnCheckedChangeListener(new OnCheckedChangeListener() {
                public void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                    if (z) {
                        conditionTag2.f25rb.setChecked(true);
    ...
    private void updateUi(final ConditionTag conditionTag, final View view, Condition condition, boolean z, final int i, Uri uri) {
        ...
        conditionTag.lines.setOnClickListener(new View.OnClickListener(this) {
            public void onClick(View view) {
                conditionTag.f25rb.setChecked(true);
            }
        });
