        ...
        while (true) {
            ...
            if (i < jArr.length) {
                ...
                while (i2 < jArr2.length) {
                    appearAnimationCreator.createAnimation(tArr[i][i2], jArr2[i2], this.mDuration, this.mAppearing ? rowTranslationScale : -rowTranslationScale, this.mAppearing, this.mInterpolator, (appearAnimationProperties2.maxDelayRowIndex == i && appearAnimationProperties2.maxDelayColIndex == i2) ? runnable : null);
                    i2++;
                }
                i++;
            } else {
