...
public class CachedBluetoothDevice implements Comparable<CachedBluetoothDevice> {
    ...
    public boolean mIsA2dpProfileConnectedFail;
    private boolean mIsActiveDeviceA2dp = false;
    private boolean mIsActiveDeviceHeadset = false;
    private boolean mIsActiveDeviceHearingAid = false;
    /* access modifiers changed from: private */
    public boolean mIsHeadsetProfileConnectedFail;
    /* access modifiers changed from: private */
    public boolean mIsHearingAidProfileConnectedFail;
    ...
    private boolean updateProfiles() {
        ...
        sb.append(this.mDevice.getAlias());
        sb.append(", ");
        sb.append(this.mDevice);
    ...
    public void onUuidChanged() {
        updateProfiles();
        ParcelUuid[] uuids = this.mDevice.getUuids();
        long j = ArrayUtils.contains(uuids, BluetoothUuid.HOGP) ? 30000 : ArrayUtils.contains(uuids, BluetoothUuid.HEARING_AID) ? 15000 : 5000;
        StringBuilder sb = new StringBuilder();
