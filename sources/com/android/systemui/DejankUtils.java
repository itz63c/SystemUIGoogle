...
public class DejankUtils {
    ...
    private static final ProxyTransactListener sProxy = new ProxyTransactListener() {
        ...
        public java.lang.Object onTransactStarted(android.os.IBinder r2, int r3, int r4) {
            ...
            L_0x0061:
                ...
                throw r2
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.systemui.DejankUtils.C06691.onTransactStarted(android.os.IBinder, int, int):java.lang.Object");
        }
    };
    /* access modifiers changed from: private */
    public static boolean sTemporarilyIgnoreStrictMode;
    /* access modifiers changed from: private */
    public static final HashSet<String> sWhitelistedFrameworkClasses = new HashSet<>();
    ...
    static {
        ...
        if (STRICT_MODE_ENABLED) {
            ...
            StrictMode.setThreadPolicy(new Builder().detectCustomSlowCalls().penaltyFlashScreen().penaltyLog().build());
        }
    }

    static /* synthetic */ void lambda$static$0() {
        for (int i = 0; i < sPendingRunnables.size(); i++) {
            sHandler.post((Runnable) sPendingRunnables.get(i));
        }
