...
public class FalsingManagerProxy implements FalsingManager, Dumpable {
    ...
    private OnPropertiesChangedListener mDeviceConfigListener;
    ...
    FalsingManagerProxy(final Context context, PluginManager pluginManager, Executor executor, DisplayMetrics displayMetrics, ProximitySensor proximitySensor, DeviceConfigProxy deviceConfigProxy, DockManager dockManager, KeyguardUpdateMonitor keyguardUpdateMonitor, DumpManager dumpManager, Executor executor2, StatusBarStateController statusBarStateController) {
        ...
        String str = "FalsingManager";
        proximitySensor.setTag(str);
        this.mProximitySensor.setSensorDelay(1);
        this.mDeviceConfig = deviceConfigProxy;
        this.mDeviceConfigListener = new OnPropertiesChangedListener(context) {
        ...
        dumpManager.registerDumpable(str, this);
    }

    /* access modifiers changed from: private */
    /* renamed from: lambda$new$0 */
    public /* synthetic */ void lambda$new$0$FalsingManagerProxy(Context context, Properties properties) {
    ...
    private void setupFalsingManager(Context context) {
        boolean z = this.mDeviceConfig.getBoolean("systemui", "brightline_falsing_manager_enabled", true);
        if (z != this.mBrightlineEnabled || this.mInternalFalsingManager == null) {
            ...
            if (!z) {
                ...
                BrightLineFalsingManager brightLineFalsingManager = new BrightLineFalsingManager(new FalsingDataProvider(this.mDisplayMetrics), this.mKeyguardUpdateMonitor, this.mProximitySensor, this.mDeviceConfig, this.mDockManager, this.mStatusBarStateController);
                this.mInternalFalsingManager = brightLineFalsingManager;
            }
        }
    }
