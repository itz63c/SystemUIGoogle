...
public class ClassifierData {
    ...
    public boolean update(MotionEvent motionEvent) {
        if (motionEvent.getActionMasked() == 2 && this.mCurrentStrokes.size() != 0 && motionEvent.getEventTimeNano() - ((Stroke) this.mCurrentStrokes.valueAt(0)).getLastEventTimeNano() < 14166666) {
            return false;
        }
    ...
    public Stroke getStroke(int i) {
        return (Stroke) this.mCurrentStrokes.get(i);
    }
}
