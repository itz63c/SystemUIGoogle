...
public class FalsingLog {
    ...
    /* renamed from: i */
    public static void m22i(String str, String str2) {
        if (LOGCAT) {
    ...
    public static synchronized void log(String str, String str2, String str3) {
        synchronized (FalsingLog.class) {
            if (ENABLED) {
                ...
                StringBuilder sb = new StringBuilder();
                sb.append(sInstance.mFormat.format(new Date()));
                sb.append(" ");
                sb.append(str);
                sb.append(" ");
                sb.append(str2);
                sb.append(" ");
                sb.append(str3);
                sInstance.mLog.add(sb.toString());
            }
        }
    }
        ...
        synchronized (FalsingLog.class) {
            ...
            if (sInstance != null) {
                if (!sInstance.mLog.isEmpty()) {
                    Iterator it = sInstance.mLog.iterator();
                    while (it.hasNext()) {
