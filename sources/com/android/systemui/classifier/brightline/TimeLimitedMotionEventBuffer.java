...
public class TimeLimitedMotionEventBuffer implements List<MotionEvent> {
    ...
    private void ejectOldEvents() {
        if (!this.mMotionEvents.isEmpty()) {
            ...
            long eventTime = ((MotionEvent) this.mMotionEvents.getLast()).getEventTime();
            while (listIterator.hasNext()) {
                MotionEvent motionEvent = (MotionEvent) listIterator.next();
    ...
    public MotionEvent remove(int i) {
        return (MotionEvent) this.mMotionEvents.remove(i);
    }
    ...
    public MotionEvent get(int i) {
        return (MotionEvent) this.mMotionEvents.get(i);
    }
