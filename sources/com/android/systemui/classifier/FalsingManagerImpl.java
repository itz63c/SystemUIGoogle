...
public class FalsingManagerImpl implements FalsingManager {
    ...
    public StateListener mStatusBarStateListener = new StateListener() {
        public void onStateChanged(int i) {
            if (FalsingLog.ENABLED) {
                ...
                FalsingLog.m22i("setStatusBarState", sb.toString());
            }
        ...
        if (z || !shouldSessionBeActive()) {
            ...
            if (this.mIsFalseTouchCalls != 0) {
                if (FalsingLog.ENABLED) {
                    ...
                    FalsingLog.m22i("isFalseTouchCalls", sb.toString());
                }
    ...
    private void onSessionStart() {
        if (FalsingLog.ENABLED) {
            ...
            sb.append(isClassifierEnabled());
            FalsingLog.m22i("onSessionStart", sb.toString());
            clearPendingWtf();
        }
    ...
    public boolean isFalseTouch() {
        ...
        if (!isFalseTouch) {
            if (FalsingLog.ENABLED) {
                ...
                FalsingLog.m22i("isFalseTouchCalls", sb2.toString());
            }
    ...
    public /* synthetic */ void lambda$isFalseTouch$2$FalsingManagerImpl(int i, int i2, String str, Throwable th) {
        StringBuilder sb = new StringBuilder();
        sb.append("Session did not become active after query for a false touch.");
        sb.append(" enabled=");
        sb.append(i);
        sb.append('/');
        sb.append(isEnabled() ? 1 : 0);
        ...
        sb.append(str);
        sb.append('/');
        sb.append(StatusBarState.toShortString(this.mState));
        sb.append(". Look for warnings ~1000ms earlier to see root cause.");
        FalsingLog.wtf("isFalseTouch", sb.toString(), th);
    }
    ...
    public void onScreenTurningOn() {
        if (FalsingLog.ENABLED) {
            ...
            sb.append("from=");
            sb.append(this.mScreenOn ? 1 : 0);
            FalsingLog.m22i("onScreenTurningOn", sb.toString());
            clearPendingWtf();
        }
        this.mScreenOn = true;
    ...
    public void onScreenOnFromTouch() {
        if (FalsingLog.ENABLED) {
            ...
            sb.append("from=");
            sb.append(this.mScreenOn ? 1 : 0);
            FalsingLog.m22i("onScreenOnFromTouch", sb.toString());
        }
        this.mScreenOn = true;
        if (sessionEntrypoint()) {
    ...
    public void onScreenOff() {
        if (FalsingLog.ENABLED) {
            ...
            sb.append("from=");
            sb.append(this.mScreenOn ? 1 : 0);
            FalsingLog.m22i("onScreenOff", sb.toString());
        }
    ...
    public void onSuccessfulUnlock() {
        if (FalsingLog.ENABLED) {
            FalsingLog.m22i("onSucccessfulUnlock", "");
        }
    ...
    public void onBouncerShown() {
        if (FalsingLog.ENABLED) {
            ...
            FalsingLog.m22i("onBouncerShown", sb.toString());
        }
        if (!this.mBouncerOn) {
    ...
    public void onBouncerHidden() {
        if (FalsingLog.ENABLED) {
            ...
            sb.append("from=");
            sb.append(this.mBouncerOn ? 1 : 0);
            FalsingLog.m22i("onBouncerHidden", sb.toString());
        }
        if (this.mBouncerOn) {
            this.mBouncerOn = false;
    ...
    public void onTrackingStarted(boolean z) {
        if (FalsingLog.ENABLED) {
            FalsingLog.m22i("onTrackingStarted", "");
        }
    ...
    public void onNotificationDoubleTap(boolean z, float f, float f2) {
        if (FalsingLog.ENABLED) {
            ...
            sb.append(f2);
            sb.append(" (px)");
            FalsingLog.m22i("onNotificationDoubleTap", sb.toString());
        }
    ...
    public void onNotificatonStartDraggingDown() {
        if (FalsingLog.ENABLED) {
            FalsingLog.m22i("onNotificatonStartDraggingDown", "");
        }
    ...
    public void onStartExpandingFromPulse() {
        if (FalsingLog.ENABLED) {
            FalsingLog.m22i("onStartExpandingFromPulse", "");
        }
    ...
    public void onNotificatonStartDismissing() {
        if (FalsingLog.ENABLED) {
            FalsingLog.m22i("onNotificatonStartDismissing", "");
        }
    ...
    public void onAffordanceSwipingStarted(boolean z) {
        if (FalsingLog.ENABLED) {
            FalsingLog.m22i("onAffordanceSwipingStarted", "");
        }
        if (z) {
