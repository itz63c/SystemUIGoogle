...
public class UserDetailItemView extends LinearLayout {
    protected static int layoutResId = C2013R$layout.qs_user_detail_item;
    ...
    public void onFinishInflate() {
        this.mAvatar = (UserAvatarView) findViewById(C2011R$id.user_picture);
        TextView textView = (TextView) findViewById(C2011R$id.user_name);
        this.mName = textView;
        ...
        updateTextStyle();
        this.mRestrictedPadlock = findViewById(C2011R$id.restricted_padlock);
    }
    ...
    public int getFontSizeDimen() {
        return C2009R$dimen.qs_detail_item_secondary_text_size;
    }
}
