...
public class AirplaneModeTile extends QSTileImpl<BooleanState> {
    ...
    private final Icon mIcon = ResourceIcon.get(17302791);
    ...
    public CharSequence getTileLabel() {
        return this.mContext.getString(C2017R$string.airplane_mode);
    }
    ...
    public void handleUpdateState(BooleanState booleanState, Object obj) {
        ...
        booleanState.label = this.mContext.getString(C2017R$string.airplane_mode);
    ...
    public String composeChangeAnnouncement() {
        if (((BooleanState) this.mState).value) {
            return this.mContext.getString(C2017R$string.accessibility_quick_settings_airplane_changed_on);
        }
        return this.mContext.getString(C2017R$string.accessibility_quick_settings_airplane_changed_off);
    }
