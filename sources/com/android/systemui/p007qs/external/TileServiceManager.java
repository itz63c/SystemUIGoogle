...
public class TileServiceManager {
    ...
    TileServiceManager(TileServices tileServices, Handler handler, ComponentName componentName, Tile tile, BroadcastDispatcher broadcastDispatcher) {
        TileLifecycleManager tileLifecycleManager = new TileLifecycleManager(handler, tileServices.getContext(), tileServices, tile, new Intent().setComponent(componentName), new UserHandle(ActivityManager.getCurrentUser()), broadcastDispatcher);
        this(tileServices, handler, tileLifecycleManager);
    }
