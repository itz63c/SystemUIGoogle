...
public class SignalTileView extends QSIconViewImpl {
    ...
    private ImageView mIn = addTrafficView(C2010R$drawable.ic_qs_signal_in);
    private ImageView mOut = addTrafficView(C2010R$drawable.ic_qs_signal_out);
    ...
    public SignalTileView(Context context) {
        ...
        this.mWideOverlayIconStartPadding = context.getResources().getDimensionPixelSize(C2009R$dimen.wide_type_icon_start_padding_qs);
        this.mSignalIndicatorToIconFrameSpacing = context.getResources().getDimensionPixelSize(C2009R$dimen.signal_indicator_to_icon_frame_spacing);
    }
