...
public class PseudoGridView extends ViewGroup {
    ...
    public void onMeasure(int i, int i2) {
        if (MeasureSpec.getMode(i) != 0) {
            ...
            int makeMeasureSpec = MeasureSpec.makeMeasureSpec((size - ((i3 - 1) * this.mHorizontalSpacing)) / i3, 1073741824);
            ...
            for (int i7 = 0; i7 < i5; i7++) {
                ...
                int makeMeasureSpec2 = MeasureSpec.makeMeasureSpec(i10, 1073741824);
                while (i9 < min) {
