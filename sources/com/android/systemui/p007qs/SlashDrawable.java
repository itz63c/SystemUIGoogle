...
public class SlashDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        this.mPath.reset();
        this.mPath.addRoundRect(this.mSlashRect, scale, scale2, Direction.CW);
        ...
        this.mPath.transform(matrix);
        this.mPath.addRoundRect(this.mSlashRect, ((float) width) * 1.0f, ((float) height) * 1.0f, Direction.CW);
        matrix.setRotate(this.mRotation - 0.099609375f, f, f2);
        this.mPath.transform(matrix);
