...
public class ActivityStarterDelegate implements ActivityStarter {
    ...
    public void startPendingIntentDismissingKeyguard(PendingIntent pendingIntent) {
        this.mActualStarter.ifPresent(new Consumer(pendingIntent) {
            ...
            public final void accept(Object obj) {
                ((StatusBar) ((Lazy) obj).get()).lambda$postStartActivityDismissingKeyguard$23(this.f$0);
            }
        });
    }
    ...
    public void startActivity(Intent intent, boolean z, Callback callback) {
    ...
    public void dismissKeyguardThenExecute(OnDismissAction onDismissAction, Runnable runnable, boolean z) {
        this.mActualStarter.ifPresent(new Consumer(runnable, z) {
            ...
            public final void accept(Object obj) {
                ((StatusBar) ((Lazy) obj).get()).dismissKeyguardThenExecute(OnDismissAction.this, this.f$1, this.f$2);
            }
        });
    }
}
