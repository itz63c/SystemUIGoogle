...
public class PipAccessibilityInteractionConnection extends Stub {
            ...
            if (i == 16) {
                this.mHandler.post(new Runnable() {
                    public final void run() {
                        PipAccessibilityInteractionConnection.this.mo12141x29fe36a1();
                    }
                });
            } else if (i == 262144) {
    ...
    public /* synthetic */ void mo12141x29fe36a1() {
    ...
    public static AccessibilityNodeInfo obtainRootAccessibilityNodeInfo() {
        ...
        obtain.addAction(AccessibilityAction.ACTION_CLICK);
        obtain.addAction(AccessibilityAction.ACTION_DISMISS);
        obtain.addAction(AccessibilityAction.ACTION_MOVE_WINDOW);
        obtain.addAction(AccessibilityAction.ACTION_EXPAND);
