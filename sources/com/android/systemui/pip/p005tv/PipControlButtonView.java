...
/* renamed from: com.android.systemui.pip.tv.PipControlButtonView */
public class PipControlButtonView extends RelativeLayout {
    ...
    public PipControlButtonView(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        ((LayoutInflater) getContext().getSystemService("layout_inflater")).inflate(C2013R$layout.tv_pip_control_button, this);
        this.mIconImageView = (ImageView) findViewById(C2011R$id.icon);
        this.mButtonImageView = (ImageView) findViewById(C2011R$id.button);
        this.mDescriptionTextView = (TextView) findViewById(C2011R$id.desc);
    ...
    public void onFinishInflate() {
        ...
        Animator loadAnimator = AnimatorInflater.loadAnimator(getContext(), C2004R$anim.tv_pip_controls_focus_gain_animation);
        this.mTextFocusGainAnimator = loadAnimator;
        loadAnimator.setTarget(this.mDescriptionTextView);
        Animator loadAnimator2 = AnimatorInflater.loadAnimator(getContext(), C2004R$anim.tv_pip_controls_focus_gain_animation);
        this.mButtonFocusGainAnimator = loadAnimator2;
        loadAnimator2.setTarget(this.mButtonImageView);
        Animator loadAnimator3 = AnimatorInflater.loadAnimator(getContext(), C2004R$anim.tv_pip_controls_focus_loss_animation);
        this.mTextFocusLossAnimator = loadAnimator3;
        loadAnimator3.setTarget(this.mDescriptionTextView);
        Animator loadAnimator4 = AnimatorInflater.loadAnimator(getContext(), C2004R$anim.tv_pip_controls_focus_loss_animation);
