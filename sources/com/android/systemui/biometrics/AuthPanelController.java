...
public class AuthPanelController extends ViewOutlineProvider {
    ...
    public void updateForContentDimensions(int i, int i2, int i3) {
        ...
        if (this.mUseFullScreen) {
            ...
            i4 = (int) this.mContext.getResources().getDimension(C2009R$dimen.biometric_dialog_border_padding);
        }
        if (this.mUseFullScreen) {
            f = 0.0f;
        } else {
            f = this.mContext.getResources().getDimension(C2009R$dimen.biometric_dialog_corner_size);
        }
        if (i3 > 0) {
    ...
    AuthPanelController(Context context, View view) {
        ...
        this.mCornerRadius = context.getResources().getDimension(C2009R$dimen.biometric_dialog_corner_size);
        this.mMargin = (int) context.getResources().getDimension(C2009R$dimen.biometric_dialog_border_padding);
