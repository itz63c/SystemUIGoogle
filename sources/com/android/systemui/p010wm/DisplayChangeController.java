...
/* renamed from: com.android.systemui.wm.DisplayChangeController */
public class DisplayChangeController {
    ...
    /* renamed from: com.android.systemui.wm.DisplayChangeController$OnDisplayChangingListener */
    ...
    public DisplayChangeController(Handler handler, IWindowManager iWindowManager) {
        C17911 r0 = new Stub() {
            public void onRotateDisplay(int i, int i2, int i3, IDisplayWindowRotationCallback iDisplayWindowRotationCallback) {
                Handler access$000 = DisplayChangeController.this.mHandler;
                $$Lambda$DisplayChangeController$1$cr2NyoFjnt2r0DMHwy9cOe5oGO4 r1 = new Runnable(i, i2, i3, iDisplayWindowRotationCallback) {
                    ...
                    public final void run() {
                        C17911.this.lambda$onRotateDisplay$0$DisplayChangeController$1(this.f$1, this.f$2, this.f$3, this.f$4);
                    }
                };
                access$000.post(r1);
            }
