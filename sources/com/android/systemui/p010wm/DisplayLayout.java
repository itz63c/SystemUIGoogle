...
/* renamed from: com.android.systemui.wm.DisplayLayout */
public class DisplayLayout {
    ...
    static int getStatusBarHeight(boolean z, Resources resources) {
        if (z) {
            return resources.getDimensionPixelSize(17105463);
        }
    ...
    static boolean hasNavigationBar(DisplayInfo displayInfo, Context context, int i) {
        ...
        boolean z3 = Global.getInt(context.getContentResolver(), "force_desktop_mode_on_external_displays", 0) != 0;
    ...
    public static int navigationBarPosition(Resources resources, int i, int i2, int i3) {
        if (!(i != i2 && resources.getBoolean(17891487)) || i <= i2) {
            return 4;
        }
        return i3 == 1 ? 2 : 1;
    }
    ...
    public static int getNavigationBarSize(Resources resources, int i, boolean z, int i2) {
        if ((i2 & 15) == 3) {
            if (i != 4) {
                return resources.getDimensionPixelSize(17105321);
            }
            return resources.getDimensionPixelSize(z ? 17105318 : 17105316);
        } else if (i != 4) {
            return resources.getDimensionPixelSize(17105320);
        } else {
            return resources.getDimensionPixelSize(z ? 17105317 : 17105315);
        }
    }
}
