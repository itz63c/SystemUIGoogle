...
public class StackAnimationController extends PhysicsAnimationController {
    ...
    private final FloatingContent mStackFloatingContent = new FloatingContent() {
    ...
    private HashMap<ViewProperty, DynamicAnimation> mStackPositionAnimations = new HashMap<>();
    ...
    private class StackPositionProperty extends FloatPropertyCompat<StackAnimationController> {
        private final ViewProperty mProperty;

        private StackPositionProperty(ViewProperty viewProperty) {
    ...
    public StackAnimationController(FloatingContentCoordinator floatingContentCoordinator, IntSupplier intSupplier) {
    ...
    public float flingStackThenSpringToEdge(float f, float f2, float f3) {
        ...
        if (!(physicsAnimationLayout == null || physicsAnimationLayout.getChildCount() == 0)) {
            float f7 = (f6 - f) * 9.24f;
            notifyFloatingCoordinatorStackAnimatingTo(f6, PhysicsAnimator.estimateFlingEndValue(this.mStackPosition.y, f3, new FlingConfig(2.2f, allowableStackPositionRegion.top, allowableStackPositionRegion.bottom)));
            if (z) {
                f4 = Math.min(f7, f2);
            } else {
                f4 = Math.max(f7, f2);
            ...
            springForce.setDampingRatio(0.85f);
            flingThenSpringFirstBubbleWithStackFollowing(viewProperty, f8, 2.2f, springForce, Float.valueOf(f6));
            ViewProperty viewProperty2 = DynamicAnimation.TRANSLATION_Y;
            SpringForce springForce2 = new SpringForce();
    ...
    public void flingThenSpringFirstBubbleWithStackFollowing(ViewProperty viewProperty, float f, float f2, SpringForce springForce, Float f3) {
        float f4;
        float f5;
        ...
        $$Lambda$StackAnimationController$bZgezj9fblRl_isenTD4ApewvoU r0 = new OnAnimationEndListener(viewProperty, springForce, f3, f6, f7) {
            ...
            public final void onAnimationEnd(DynamicAnimation dynamicAnimation, boolean z, float f, float f2) {
                StackAnimationController.this.mo10647xc55c386e(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, dynamicAnimation, z, f, f2);
            }
        };
        flingAnimation.addEndListener(r0);
    ...
    public /* synthetic */ void mo10647xc55c386e(ViewProperty viewProperty, SpringForce springForce, Float f, float f2, float f3, DynamicAnimation dynamicAnimation, boolean z, float f4, float f5) {
        float f6;
        if (!z) {
    ...
    public void implodeStack(Runnable runnable) {
        PhysicsPropertyAnimator animationForChildAtIndex = animationForChildAtIndex(0);
    ...
    /* access modifiers changed from: protected */
    public void springFirstBubbleWithStackFollowing(ViewProperty viewProperty, SpringForce springForce, float f, float f2, Runnable... runnableArr) {
        if (this.mLayout.getChildCount() != 0) {
            ...
            springAnimation.addEndListener(new OnAnimationEndListener(runnableArr) {
                ...
                public final void onAnimationEnd(DynamicAnimation dynamicAnimation, boolean z, float f, float f2) {
                    StackAnimationController.this.mo10649x32f807ee(this.f$1, dynamicAnimation, z, f, f2);
                }
            });
    ...
    /* access modifiers changed from: private */
    /* renamed from: lambda$springFirstBubbleWithStackFollowing$1 */
    public /* synthetic */ void mo10649x32f807ee(Runnable[] runnableArr, DynamicAnimation dynamicAnimation, boolean z, float f, float f2) {
        this.mRestingStackPosition.set(this.mStackPosition);
        if (runnableArr != null) {
    ...
    public Set<ViewProperty> getAnimatedProperties() {
        return Sets.newHashSet(new ViewProperty[]{DynamicAnimation.TRANSLATION_X, DynamicAnimation.TRANSLATION_Y, DynamicAnimation.ALPHA, DynamicAnimation.SCALE_X, DynamicAnimation.SCALE_Y});
    }
    ...
    public void onActiveControllerForLayout(PhysicsAnimationLayout physicsAnimationLayout) {
        ...
        this.mStackOffset = (float) resources.getDimensionPixelSize(C2009R$dimen.bubble_stack_offset);
        this.mBubbleSize = resources.getDimensionPixelSize(C2009R$dimen.individual_bubble_size);
        this.mBubbleBitmapSize = resources.getDimensionPixelSize(C2009R$dimen.bubble_bitmap_size);
        this.mBubblePaddingTop = resources.getDimensionPixelSize(C2009R$dimen.bubble_padding_top);
        this.mBubbleOffscreen = resources.getDimensionPixelSize(C2009R$dimen.bubble_stack_offscreen);
        this.mStackStartingVerticalOffset = resources.getDimensionPixelSize(C2009R$dimen.bubble_stack_starting_offset_y);
    ...
    private void moveStackToStartPosition() {
        ...
        this.mLayout.post(new Runnable() {
            public final void run() {
                StackAnimationController.this.lambda$moveStackToStartPosition$2$StackAnimationController();
            }
        });
    }

    /* access modifiers changed from: private */
    /* renamed from: lambda$moveStackToStartPosition$2 */
    public /* synthetic */ void lambda$moveStackToStartPosition$2$StackAnimationController() {
        PointF pointF = this.mRestingStackPosition;
        if (pointF == null) {
            pointF = getDefaultStartPosition();
        }
    ...
    /* access modifiers changed from: private */
    public void moveFirstBubbleWithStackFollowing(ViewProperty viewProperty, float f) {
        if (viewProperty.equals(DynamicAnimation.TRANSLATION_X)) {
        ...
        if (this.mLayout.getChildCount() > 0) {
            ...
            if (this.mLayout.getChildCount() > 1) {
                PhysicsPropertyAnimator animationForChildAtIndex = animationForChildAtIndex(1);
    ...
    public PointF getDefaultStartPosition() {
        return new PointF(getAllowableStackPositionRegion().left, getAllowableStackPositionRegion().top + ((float) this.mStackStartingVerticalOffset));
    }
    ...
    private void cancelStackPositionAnimation(ViewProperty viewProperty) {
    ...
    public MagnetizedObject<StackAnimationController> getMagnetizedStack(MagneticTarget magneticTarget) {
        if (this.mMagnetizedStack == null) {
            C07992 r1 = new MagnetizedObject<StackAnimationController>(this.mLayout.getContext(), this, new StackPositionProperty(DynamicAnimation.TRANSLATION_X), new StackPositionProperty(DynamicAnimation.TRANSLATION_Y)) {
