...
public final class PhoneStateMonitor {
    ...
    PhoneStateMonitor(Context context, BroadcastDispatcher broadcastDispatcher, Optional<Lazy<StatusBar>> optional, BootCompleteCache bootCompleteCache) {
        ...
        bootCompleteCache.addListener(new BootCompleteListener() {
    ...
    /* access modifiers changed from: private */
    public boolean isLauncherShowing(RunningTaskInfo runningTaskInfo) {
    ...
    private boolean isAppImmersive() {
        return ((StatusBar) ((Lazy) this.mStatusBarOptionalLazy.get()).get()).inImmersiveMode();
    }

    private boolean isAppFullscreen() {
        return ((StatusBar) ((Lazy) this.mStatusBarOptionalLazy.get()).get()).inFullscreenMode();
    }
