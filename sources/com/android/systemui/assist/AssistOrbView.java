...
public class AssistOrbView extends FrameLayout {
    ...
    public AssistOrbView(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.mCircleMinSize = context.getResources().getDimensionPixelSize(C2009R$dimen.assist_orb_size);
        this.mBaseMargin = context.getResources().getDimensionPixelSize(C2009R$dimen.assist_orb_base_margin);
        this.mStaticOffset = context.getResources().getDimensionPixelSize(C2009R$dimen.assist_orb_travel_distance);
        this.mMaxElevation = context.getResources().getDimensionPixelSize(C2009R$dimen.assist_orb_elevation);
        this.mBackgroundPaint.setAntiAlias(true);
        this.mBackgroundPaint.setColor(getResources().getColor(C2008R$color.assist_orb_color));
    }
    ...
    public void onFinishInflate() {
        ...
        this.mLogo = (ImageView) findViewById(C2011R$id.search_logo);
    }
    ...
    private void updateLogo() {
        ...
        float f2 = height + (((float) i) * f * 0.1f);
