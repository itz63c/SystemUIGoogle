...
public class AssistOrbContainer extends FrameLayout {
    ...
    public void onFinishInflate() {
        ...
        this.mScrim = findViewById(C2011R$id.assist_orb_scrim);
        this.mNavbarScrim = findViewById(C2011R$id.assist_orb_navbar_scrim);
        this.mOrb = (AssistOrbView) findViewById(C2011R$id.assist_orb);
    }
