...
public class PerimeterPathGuide {
    ...
    private int getPhysicalCornerRadius(Corner corner) {
    ...
    private void computeRegions() {
        ...
        Corner rotatedCorner = getRotatedCorner(Corner.BOTTOM_LEFT);
        Corner rotatedCorner2 = getRotatedCorner(Corner.BOTTOM_RIGHT);
        Corner rotatedCorner3 = getRotatedCorner(Corner.TOP_LEFT);
        Corner rotatedCorner4 = getRotatedCorner(Corner.TOP_RIGHT);
    ...
    private Corner getRotatedCorner(Corner corner) {
        ...
        return Corner.values()[ordinal % 4];
    }
