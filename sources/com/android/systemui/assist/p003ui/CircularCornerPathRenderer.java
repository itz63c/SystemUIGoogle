...
public final class CircularCornerPathRenderer extends CornerPathRenderer {
    ...
    static /* synthetic */ class C07431 {
        ...
        static final /* synthetic */ int[] f32x853e7b3e;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f32x853e7b3e     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f32x853e7b3e     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f32x853e7b3e     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.systemui.assist.p003ui.CircularCornerPathRenderer.C07431.<clinit>():void");
        }
    }
    ...
    public Path getCornerPath(Corner corner) {
        this.mPath.reset();
        int i = C07431.f32x853e7b3e[corner.ordinal()];
        if (i == 1) {
            ...
            float f = (float) (i4 - (i5 * 2));
            int i6 = this.mHeight;
            path2.arcTo(f, (float) (i6 - (i5 * 2)), (float) i4, (float) i6, 90.0f, -90.0f, true);
        } else if (i == 3) {
