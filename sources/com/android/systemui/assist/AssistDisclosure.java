...
public class AssistDisclosure {
    ...
    private class AssistDisclosureView extends View implements AnimatorUpdateListener {
        ...
        public AssistDisclosureView(Context context) {
            ...
            PorterDuffXfermode porterDuffXfermode = new PorterDuffXfermode(Mode.SRC);
            this.mPaint.setColor(-1);
            this.mPaint.setXfermode(porterDuffXfermode);
            this.mShadowPaint.setColor(-12303292);
            this.mShadowPaint.setXfermode(porterDuffXfermode);
            this.mThickness = getResources().getDimension(C2009R$dimen.assist_disclosure_thickness);
            this.mShadowThickness = getResources().getDimension(C2009R$dimen.assist_disclosure_shadow_thickness);
        }
    ...
    public void show() {
        ...
        if (!this.mViewAdded) {
            LayoutParams layoutParams = new LayoutParams(2015, 525576, -3);
