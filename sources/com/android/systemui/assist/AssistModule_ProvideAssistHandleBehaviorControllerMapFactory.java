...
public final class AssistModule_ProvideAssistHandleBehaviorControllerMapFactory implements Factory<Map<AssistHandleBehavior, BehaviorController>> {
    ...
    public Map<AssistHandleBehavior, BehaviorController> get() {
        return provideInstance(this.offBehaviorProvider, this.likeHomeBehaviorProvider, this.reminderExpBehaviorProvider);
    }

    public static Map<AssistHandleBehavior, BehaviorController> provideInstance(Provider<AssistHandleOffBehavior> provider, Provider<AssistHandleLikeHomeBehavior> provider2, Provider<AssistHandleReminderExpBehavior> provider3) {
    ...
    public static Map<AssistHandleBehavior, BehaviorController> proxyProvideAssistHandleBehaviorControllerMap(Object obj, Object obj2, Object obj3) {
        Map<AssistHandleBehavior, BehaviorController> provideAssistHandleBehaviorControllerMap = AssistModule.provideAssistHandleBehaviorControllerMap((AssistHandleOffBehavior) obj, (AssistHandleLikeHomeBehavior) obj2, (AssistHandleReminderExpBehavior) obj3);
