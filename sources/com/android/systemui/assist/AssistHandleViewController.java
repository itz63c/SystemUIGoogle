...
public class AssistHandleViewController implements DarkIntensityListener {
    ...
    public AssistHandleViewController(Handler handler, View view) {
        ...
        this.mAssistHintLeft = (CornerHandleView) view.findViewById(C2011R$id.assist_hint_left);
        this.mAssistHintRight = (CornerHandleView) view.findViewById(C2011R$id.assist_hint_right);
    }
