...
public class WifiDebuggingActivity extends AlertActivity implements OnClickListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        alertParams.mTitle = getString(C2017R$string.wifi_debugging_title);
        alertParams.mMessage = getString(C2017R$string.wifi_debugging_message, new Object[]{stringExtra, this.mBssid});
        alertParams.mPositiveButtonText = getString(C2017R$string.wifi_debugging_allow);
        ...
        checkBox.setText(getString(C2017R$string.wifi_debugging_always));
    ...
    public void onDestroy() {
        ...
        if (!this.mClicked) {
            try {
                Stub.asInterface(ServiceManager.getService("adb")).denyWirelessDebugging();
            } catch (Exception e) {
