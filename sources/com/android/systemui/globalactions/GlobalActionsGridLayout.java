...
public class GlobalActionsGridLayout extends GlobalActionsLayout {
    ...
    public void updateSeparatedItemSize() {
        ...
        if (separatedView.getChildCount() != 0) {
            LayoutParams layoutParams = separatedView.getChildAt(0).getLayoutParams();
    ...
    public float getAnimationDistance() {
        return (((float) getListView().getRowCount()) * getContext().getResources().getDimension(C2009R$dimen.global_actions_grid_item_height)) / 2.0f;
    }
