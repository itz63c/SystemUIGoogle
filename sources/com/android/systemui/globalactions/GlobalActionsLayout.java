...
public abstract class GlobalActionsLayout extends MultiListLayout {
    ...
    private void setBackgrounds() {
        ...
        HardwareBgDrawable backgroundDrawable = getBackgroundDrawable(getResources().getColor(C2008R$color.global_actions_grid_background, null));
        if (backgroundDrawable != null) {
            listView.setBackground(backgroundDrawable);
        }
        if (getSeparatedView() != null) {
            HardwareBgDrawable backgroundDrawable2 = getBackgroundDrawable(getResources().getColor(C2008R$color.global_actions_separated_background, null));
            if (backgroundDrawable2 != null) {
                getSeparatedView().setBackground(backgroundDrawable2);
            }
        }
    }
    ...
    public ViewGroup getSeparatedView() {
        return (ViewGroup) findViewById(C2011R$id.separated_button);
    }
