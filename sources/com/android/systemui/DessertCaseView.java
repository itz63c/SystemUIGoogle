...
public class DessertCaseView extends FrameLayout {
    ...
    private static final int[] PASTRIES = {C2010R$drawable.dessert_kitkat, C2010R$drawable.dessert_android};
    private static final int[] RARE_PASTRIES = {C2010R$drawable.dessert_cupcake, C2010R$drawable.dessert_donut, C2010R$drawable.dessert_eclair, C2010R$drawable.dessert_froyo, C2010R$drawable.dessert_gingerbread, C2010R$drawable.dessert_honeycomb, C2010R$drawable.dessert_ics, C2010R$drawable.dessert_jellybean};
    private static final int[] XRARE_PASTRIES = {C2010R$drawable.dessert_petitfour, C2010R$drawable.dessert_donutburger, C2010R$drawable.dessert_flan, C2010R$drawable.dessert_keylimepie};
    ...
    static {
        ...
        int[] iArr = {C2010R$drawable.dessert_zombiegingerbread, C2010R$drawable.dessert_dandroid, C2010R$drawable.dessert_jandycane};
    ...
    public DessertCaseView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mStarted = false;
        this.mCellSize = resources.getDimensionPixelSize(C2009R$dimen.dessert_case_cell_size);
    ...
    public synchronized void fillFreeList(int i) {
        ...
        LayoutParams layoutParams = new LayoutParams(this.mCellSize, this.mCellSize);
        while (!this.mFreeList.isEmpty()) {
            ...
            if (this.mCells[(point.y * this.mColumns) + point.x] == null) {
                ...
                float frand = frand();
                Drawable drawable = frand < 5.0E-4f ? (Drawable) this.mDrawables.get(pick(XXRARE_PASTRIES)) : frand < 0.005f ? (Drawable) this.mDrawables.get(pick(XRARE_PASTRIES)) : frand < 0.5f ? (Drawable) this.mDrawables.get(pick(RARE_PASTRIES)) : frand < 0.7f ? (Drawable) this.mDrawables.get(pick(PASTRIES)) : null;
                if (drawable != null) {
    ...
    private final AnimatorListener makeHardwareLayerListener(final View view) {
