...
public class VolumeUI extends SystemUI {
    ...
    public void start() {
        boolean z = this.mContext.getResources().getBoolean(C2007R$bool.enable_volume_ui);
        boolean z2 = this.mContext.getResources().getBoolean(C2007R$bool.enable_safety_warning);
        boolean z3 = z || z2;
        this.mEnabled = z3;
        if (z3) {
