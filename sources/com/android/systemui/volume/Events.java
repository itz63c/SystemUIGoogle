...
public class Events {
    ...
    @VisibleForTesting
    public enum VolumeDialogCloseEvent implements UiEventEnum {
        INVALID(0),
    ...
    @VisibleForTesting
    public enum VolumeDialogEvent implements UiEventEnum {
        INVALID(0),
    ...
    @VisibleForTesting
    public enum VolumeDialogOpenEvent implements UiEventEnum {
        INVALID(0),
    ...
    @VisibleForTesting
    public enum ZenModeEvent implements UiEventEnum {
        INVALID(0),
        ZEN_MODE_OFF(335),
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:29:0x013e, code lost:
        ...
        r0.append(r8[1]);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:47:0x0270, code lost:
        return r0.toString();
     */
