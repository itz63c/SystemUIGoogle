...
public class VolumeToolTipView extends LinearLayout {
    ...
    private void drawArrow() {
        View findViewById = findViewById(C2011R$id.arrow);
        ...
        paint.setPathEffect(new CornerPathEffect(getResources().getDimension(C2009R$dimen.volume_tool_tip_arrow_corner_radius)));
