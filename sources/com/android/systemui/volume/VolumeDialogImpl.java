...
public class VolumeDialogImpl implements VolumeDialog, ConfigurationListener {
    ...
    /* access modifiers changed from: private */
    public final C1777H mHandler = new C1777H();
    ...
    private final class CustomDialog extends Dialog implements DialogInterface {
        public CustomDialog(Context context) {
            super(context, C2018R$style.qs_theme);
        }
    ...
    private final class C1777H extends Handler {
        public C1777H() {
    ...
    private final class VolumeSeekBarChangeListener implements OnSeekBarChangeListener {
        ...
        public void onProgressChanged(SeekBar seekBar, int i, boolean z) {
            if (this.mRow.f86ss != null) {
                ...
                if (z) {
                    if (this.mRow.f86ss.levelMin > 0) {
                        int i2 = this.mRow.f86ss.levelMin * 100;
                        if (i < i2) {
                    ...
                    if (this.mRow.f86ss.level != access$4100 || (this.mRow.f86ss.muted && access$4100 > 0)) {
        ...
        public void onStopTrackingTouch(SeekBar seekBar) {
            ...
            if (this.mRow.f86ss.level != access$4100) {
    ...
    private void initDialog() {
        ...
        attributes.gravity = this.mContext.getResources().getInteger(C2012R$integer.volume_dialog_gravity);
        this.mWindow.setAttributes(attributes);
        this.mWindow.setLayout(-2, -2);
        this.mDialog.setContentView(C2013R$layout.volume_dialog);
        ViewGroup viewGroup = (ViewGroup) this.mDialog.findViewById(C2011R$id.volume_dialog);
        ...
        this.mDialogRowsView = (ViewGroup) this.mDialog.findViewById(C2011R$id.volume_dialog_rows);
        ViewGroup viewGroup2 = (ViewGroup) this.mDialog.findViewById(C2011R$id.ringer);
        this.mRinger = viewGroup2;
        if (viewGroup2 != null) {
            this.mRingerIcon = (ImageButton) viewGroup2.findViewById(C2011R$id.ringer_icon);
            this.mZenIcon = (FrameLayout) this.mRinger.findViewById(C2011R$id.dnd_icon);
        }
        ViewGroup viewGroup3 = (ViewGroup) this.mDialog.findViewById(C2011R$id.odi_captions);
        this.mODICaptionsView = viewGroup3;
        if (viewGroup3 != null) {
            this.mODICaptionsIcon = (CaptionsToggleImageButton) viewGroup3.findViewById(C2011R$id.odi_captions_icon);
        }
        ViewStub viewStub = (ViewStub) this.mDialog.findViewById(C2011R$id.odi_captions_tooltip_stub);
        ...
        this.mSettingsView = this.mDialog.findViewById(C2011R$id.settings_container);
        this.mSettingsIcon = (ImageButton) this.mDialog.findViewById(C2011R$id.settings);
        if (this.mRows.isEmpty()) {
            if (!AudioSystem.isSingleVolume(this.mContext)) {
                int i = C2010R$drawable.ic_volume_accessibility;
                addRow(10, i, i, true, false);
            }
            addRow(3, C2010R$drawable.ic_volume_media, C2010R$drawable.ic_volume_media_mute, true, true);
            if (!AudioSystem.isSingleVolume(this.mContext)) {
                addRow(2, C2010R$drawable.ic_volume_ringer, C2010R$drawable.ic_volume_ringer_mute, true, false);
                addRow(4, C2010R$drawable.ic_alarm, C2010R$drawable.ic_volume_alarm_mute, true, false);
                addRow(0, 17302781, 17302781, false, false);
                int i2 = C2010R$drawable.ic_volume_bt_sco;
                addRow(6, i2, i2, false, false);
                addRow(1, C2010R$drawable.ic_volume_system, C2010R$drawable.ic_volume_system_mute, false, false);
            }
        } else {
            addExistingRows();
        }
    ...
    private void initRow(VolumeRow volumeRow, int i, int i2, int i3, boolean z, boolean z2) {
        ...
        volumeRow.view = this.mDialog.getLayoutInflater().inflate(C2013R$layout.volume_dialog_row, null);
        volumeRow.view.setId(volumeRow.stream);
        volumeRow.view.setTag(volumeRow);
        volumeRow.header = (TextView) volumeRow.view.findViewById(C2011R$id.volume_row_header);
        volumeRow.header.setId(volumeRow.stream * 20);
        if (i == 10) {
            volumeRow.header.setFilters(new InputFilter[]{new LengthFilter(13)});
        }
        volumeRow.dndIcon = (FrameLayout) volumeRow.view.findViewById(C2011R$id.dnd_icon);
        volumeRow.slider = (SeekBar) volumeRow.view.findViewById(C2011R$id.volume_row_slider);
        volumeRow.slider.setOnSeekBarChangeListener(new VolumeSeekBarChangeListener(volumeRow));
        volumeRow.anim = null;
        volumeRow.icon = (ImageButton) volumeRow.view.findViewById(C2011R$id.volume_row_icon);
        ...
        if (volumeRow.stream != 10) {
            volumeRow.icon.setOnClickListener(new OnClickListener(volumeRow, i) {
                public final /* synthetic */ VolumeRow f$1;
    ...
    public /* synthetic */ void lambda$initRow$3$VolumeDialogImpl(VolumeRow volumeRow, int i, View view) {
        ...
        if (volumeRow.stream == 2) {
            ...
            if (volumeRow.f86ss.level == volumeRow.f86ss.levelMin) {
                i2 = 1;
            }
            this.mController.setStreamVolume(i, i2 != 0 ? volumeRow.lastAudibleLevel : volumeRow.f86ss.levelMin);
        }
    ...
    public void showCaptionsTooltip() {
        if (!this.mHasSeenODICaptionsTooltip) {
            ...
            if (viewStub != null) {
                ...
                inflate.findViewById(C2011R$id.dismiss).setOnClickListener(new OnClickListener() {
                    public final void onClick(View view) {
    ...
    public void tryToRemoveCaptionsTooltip() {
        if (this.mHasSeenODICaptionsTooltip && this.mODICaptionsTooltipView != null) {
            ((ViewGroup) this.mDialog.findViewById(C2011R$id.volume_dialog_container)).removeView(this.mODICaptionsTooltipView);
    ...
    private void maybeShowToastH(int i) {
        ...
        if (i2 <= 12) {
            String str2 = null;
            if (i == 0) {
                str2 = this.mContext.getString(17041316);
            } else if (i != 2) {
                str2 = this.mContext.getString(17041317);
            } else {
                StreamState streamState = (StreamState) this.mState.states.get(2);
                if (streamState != null) {
                    str2 = this.mContext.getString(C2017R$string.volume_dialog_ringer_guidance_ring, new Object[]{Utils.formatPercentage((long) streamState.level, (long) streamState.levelMax)});
                }
            }
    ...
    private boolean shouldBeVisibleH(VolumeRow volumeRow, VolumeRow volumeRow2) {
        ...
        if (!this.mShowActiveStreamOnly) {
            ...
            if (volumeRow.defaultStream && (volumeRow2.stream == 2 || volumeRow2.stream == 4 || volumeRow2.stream == 0 || volumeRow2.stream == 10 || this.mDynamic.get(volumeRow2.stream))) {
                z = true;
            }
        }
        return z;
    ...
    public void updateRowsH(VolumeRow volumeRow) {
        ...
        for (VolumeRow volumeRow2 : this.mRows) {
            ...
            Util.setVisOrGone(volumeRow2.view, shouldBeVisibleH(volumeRow2, volumeRow));
        ...
        if (this.mRinger != null) {
            ...
            if (state != null) {
                ...
                if (streamState != null) {
                    ...
                    int i2 = this.mState.ringerModeInternal;
                    if (i2 == 0) {
                        this.mRingerIcon.setImageResource(C2010R$drawable.ic_volume_ringer_mute);
                        this.mRingerIcon.setTag(Integer.valueOf(2));
                        addAccessibilityDescription(this.mRingerIcon, 0, this.mContext.getString(C2017R$string.volume_ringer_hint_unmute));
                    } else if (i2 != 1) {
                        if ((this.mAutomute && streamState.level == 0) || streamState.muted) {
                            z = true;
                        }
                        if (z2 || !z) {
                            this.mRingerIcon.setImageResource(C2010R$drawable.ic_volume_ringer);
                            if (this.mController.hasVibrator()) {
                                addAccessibilityDescription(this.mRingerIcon, 2, this.mContext.getString(C2017R$string.volume_ringer_hint_vibrate));
                            } else {
                                addAccessibilityDescription(this.mRingerIcon, 2, this.mContext.getString(C2017R$string.volume_ringer_hint_mute));
                            }
                            this.mRingerIcon.setTag(Integer.valueOf(1));
                        } else {
                            this.mRingerIcon.setImageResource(C2010R$drawable.ic_volume_ringer_mute);
                            addAccessibilityDescription(this.mRingerIcon, 2, this.mContext.getString(C2017R$string.volume_ringer_hint_unmute));
                            this.mRingerIcon.setTag(Integer.valueOf(2));
                        }
                    } else {
                        this.mRingerIcon.setImageResource(C2010R$drawable.ic_volume_ringer_vibrate);
                        addAccessibilityDescription(this.mRingerIcon, 1, this.mContext.getString(C2017R$string.volume_ringer_hint_mute));
    ...
    private void addAccessibilityDescription(View view, int i, final String str) {
        int i2;
        if (i == 0) {
            i2 = C2017R$string.volume_ringer_status_silent;
        } else if (i != 1) {
            i2 = C2017R$string.volume_ringer_status_normal;
        } else {
            i2 = C2017R$string.volume_ringer_status_vibrate;
        }
        view.setContentDescription(this.mContext.getString(i2));
        view.setAccessibilityDelegate(new AccessibilityDelegate(this) {
    ...
    private void trimObsoleteH() {
        ...
        for (int size = this.mRows.size() - 1; size >= 0; size--) {
            ...
            if (volumeRow.f86ss != null && volumeRow.f86ss.dynamic && !this.mDynamic.get(volumeRow.stream)) {
        ...
        for (int i3 = 0; i3 < state.states.size(); i3++) {
            ...
            if (((StreamState) state.states.valueAt(i3)).dynamic) {
                ...
                if (findRow(keyAt) == null) {
                    addRow(keyAt, C2010R$drawable.ic_volume_remote, C2010R$drawable.ic_volume_remote_mute, true, false, true);
                }
            }
        }
    ...
    public CharSequence composeWindowTitle() {
        return this.mContext.getString(C2017R$string.volume_dialog_title, new Object[]{getStreamLabelH(getActiveRow().f86ss)});
    }
    ...
    private void updateVolumeRowH(VolumeRow volumeRow) {
        ...
        State state = this.mState;
        if (state != null) {
            StreamState streamState = (StreamState) state.states.get(volumeRow.stream);
            if (streamState != null) {
                volumeRow2.f86ss = streamState;
                int i4 = streamState.level;
                if (i4 > 0) {
                    volumeRow2.lastAudibleLevel = i4;
                }
                ...
                int i9 = z7 ? C2010R$drawable.ic_volume_ringer_vibrate : (z8 || z) ? volumeRow.iconMuteRes : streamState.routedToBluetooth ? isStreamMuted(streamState) ? C2010R$drawable.ic_volume_media_bt_mute : C2010R$drawable.ic_volume_media_bt : isStreamMuted(streamState) ? volumeRow.iconMuteRes : volumeRow.iconRes;
                volumeRow.icon.setImageResource(i9);
                if (i9 == C2010R$drawable.ic_volume_ringer_vibrate) {
                    i6 = 3;
                } else if (!(i9 == C2010R$drawable.ic_volume_media_bt_mute || i9 == volumeRow.iconMuteRes)) {
                    i6 = (i9 == C2010R$drawable.ic_volume_media_bt || i9 == volumeRow.iconRes) ? 1 : 0;
                }
                volumeRow2.iconState = i6;
                if (!z12) {
                    volumeRow.icon.setContentDescription(getStreamLabelH(streamState));
                } else if (z3) {
                    if (z7) {
                        volumeRow.icon.setContentDescription(this.mContext.getString(C2017R$string.volume_stream_content_description_unmute, new Object[]{getStreamLabelH(streamState)}));
                    } else if (this.mController.hasVibrator()) {
                        ImageButton access$1300 = volumeRow.icon;
                        Context context = this.mContext;
                        if (this.mShowA11yStream) {
                            i3 = C2017R$string.volume_stream_content_description_vibrate_a11y;
                        } else {
                            i3 = C2017R$string.volume_stream_content_description_vibrate;
                        }
                        access$1300.setContentDescription(context.getString(i3, new Object[]{getStreamLabelH(streamState)}));
                    } else {
                        ImageButton access$13002 = volumeRow.icon;
                        Context context2 = this.mContext;
                        if (this.mShowA11yStream) {
                            i2 = C2017R$string.volume_stream_content_description_mute_a11y;
                        } else {
                            i2 = C2017R$string.volume_stream_content_description_mute;
                        }
                        access$13002.setContentDescription(context2.getString(i2, new Object[]{getStreamLabelH(streamState)}));
                    }
                } else if (z2) {
                    volumeRow.icon.setContentDescription(getStreamLabelH(streamState));
                    ...
                    if (this.mShowA11yStream) {
                        i = C2017R$string.volume_stream_content_description_mute_a11y;
                    } else {
                        i = C2017R$string.volume_stream_content_description_mute;
                    }
                    access$13003.setContentDescription(context3.getString(i, new Object[]{getStreamLabelH(streamState)}));
                }
                if (z) {
                ...
                boolean z13 = !z;
                if (!volumeRow.f86ss.muted || z3 || z) {
                    i5 = volumeRow.f86ss.level;
                }
                updateVolumeRowSliderH(volumeRow2, z13, i5);
            }
        }
    }

    private boolean isStreamMuted(StreamState streamState) {
