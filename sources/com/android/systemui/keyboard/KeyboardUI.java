...
public class KeyboardUI extends SystemUI implements OnTabletModeChangedListener {
    ...
    private final class KeyboardUIHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            if (i != 8) {
                ...
                KeyboardUI.this.mDialog.setTitle(C2017R$string.enable_bluetooth_title);
                KeyboardUI.this.mDialog.setMessage(C2017R$string.enable_bluetooth_message);
                KeyboardUI.this.mDialog.setPositiveButton(C2017R$string.enable_bluetooth_confirmation_ok, bluetoothDialogClickListener);
    ...
    public void init() {
        ...
        String string = context.getString(17039822);
    ...
    private void startScanning() {
        ...
        ScanFilter build = new Builder().setDeviceName(this.mKeyboardName).build();
