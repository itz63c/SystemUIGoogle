...
public class UsbConfirmActivity extends AlertActivity implements OnClickListener, OnCheckedChangeListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (this.mDevice == null) {
            alertParams.mMessage = getString(C2017R$string.usb_accessory_confirm_prompt, new Object[]{charSequence, this.mAccessory.getDescription()});
            ...
            if (z) {
                i = C2017R$string.usb_device_confirm_prompt_warn;
            } else {
                i = C2017R$string.usb_device_confirm_prompt;
            }
