...
public class MinimizedDockShadow extends View {
    ...
    private void updatePaint(int i, int i2, int i3, int i4) {
        int color = this.mContext.getResources().getColor(C2008R$color.minimize_dock_shadow_start, null);
        int color2 = this.mContext.getResources().getColor(C2008R$color.minimize_dock_shadow_end, null);
