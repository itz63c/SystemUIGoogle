...
public class SplitDisplayLayout {
    ...
    public DividerSnapAlgorithm getSnapAlgorithm() {
        if (this.mSnapAlgorithm == null) {
            updateResources();
            DividerSnapAlgorithm dividerSnapAlgorithm = new DividerSnapAlgorithm(this.mContext.getResources(), this.mDisplayLayout.width(), this.mDisplayLayout.height(), this.mDividerSize, !this.mDisplayLayout.isLandscape(), this.mDisplayLayout.stableInsets(), getPrimarySplitSide());
    ...
    public DividerSnapAlgorithm getMinimizedSnapAlgorithm() {
        if (this.mMinimizedSnapAlgorithm == null) {
            updateResources();
            DividerSnapAlgorithm dividerSnapAlgorithm = new DividerSnapAlgorithm(this.mContext.getResources(), this.mDisplayLayout.width(), this.mDisplayLayout.height(), this.mDividerSize, !this.mDisplayLayout.isLandscape(), this.mDisplayLayout.stableInsets(), getPrimarySplitSide(), true);
            this.mMinimizedSnapAlgorithm = dividerSnapAlgorithm;
        }
    ...
    public Rect calcMinimizedHomeStackBounds() {
        SnapTarget middleTarget = getMinimizedSnapAlgorithm().getMiddleTarget();
        Rect rect = new Rect();
    ...
    private void adjustForIME(DisplayLayout displayLayout, int i, int i2, int i3, int i4, int i5, Rect rect, Rect rect2) {
        ...
        int i6 = (int) ((((float) i5) * f) + (((float) i4) * (1.0f - f)));
        int i7 = rect3.top;
        int max = Math.max(0, displayLayout.height() - Math.max(i, (i7 + ((int) (((float) (this.mPrimary.bottom - i7)) * 0.3f))) + i6));
        this.mAdjustedPrimary.set(rect);
        int i8 = -max;
        this.mAdjustedPrimary.offset(0, (i4 - i6) + i8);
    ...
    static DividerSnapAlgorithm initSnapAlgorithmForRotation(Context context, DisplayLayout displayLayout, int i) {
        ...
        DividerSnapAlgorithm dividerSnapAlgorithm = new DividerSnapAlgorithm(context.createConfigurationContext(configuration).getResources(), displayLayout.width(), displayLayout.height(), i, configuration.orientation == 1, displayLayout.stableInsets());
