...
public class TaskStackChangeListeners extends TaskStackListener {
    ...
    private final class C1077H extends Handler {
        public C1077H(Looper looper) {
            super(looper);
        }
                ...
                switch (message.what) {
                    ...
                    case 2:
                        ...
                        for (int size2 = TaskStackChangeListeners.this.mTaskStackListeners.size() - 1; size2 >= 0; size2--) {
                            ((TaskStackChangeListener) TaskStackChangeListeners.this.mTaskStackListeners.get(size2)).onTaskSnapshotChanged(message.arg1, new ThumbnailData((TaskSnapshot) message.obj));
                        }
                        Trace.endSection();
                        break;
                    case 3:
                    ...
                    case 4:
                        ...
                        RunningTaskInfo runningTaskInfo = (RunningTaskInfo) someArgs.arg1;
                        boolean z2 = someArgs.argi1 != 0;
                        if (someArgs.argi2 != 0) {
                            z = true;
                        }
                        for (int size4 = TaskStackChangeListeners.this.mTaskStackListeners.size() - 1; size4 >= 0; size4--) {
                            ((TaskStackChangeListener) TaskStackChangeListeners.this.mTaskStackListeners.get(size4)).onActivityRestartAttempt(runningTaskInfo, z2, z);
                        }
                        break;
                    case 6:
                    ...
                    case 10:
                        ...
                        break;
                    case 11:
                        RunningTaskInfo runningTaskInfo2 = (RunningTaskInfo) message.obj;
                    ...
                    case 13:
                        ...
                        break;
                    case 14:
                        RunningTaskInfo runningTaskInfo3 = (RunningTaskInfo) message.obj;
                    ...
                    case 15:
                        ...
                        break;
                    case 16:
                        RunningTaskInfo runningTaskInfo4 = (RunningTaskInfo) message.obj;
                    ...
                    case 18:
                        for (int size16 = TaskStackChangeListeners.this.mTaskStackListeners.size() - 1; size16 >= 0; size16--) {
                            ((TaskStackChangeListener) TaskStackChangeListeners.this.mTaskStackListeners.get(size16)).onBackPressedOnTaskRoot((RunningTaskInfo) message.obj);
                        }
                        break;
                    case 19:
                    ...
                    case 23:
                        ...
                        break;
                    case 24:
                        RunningTaskInfo runningTaskInfo5 = (RunningTaskInfo) message.obj;
    ...
    public TaskStackChangeListeners(Looper looper) {
        this.mHandler = new C1077H(looper);
    }
    ...
    public void onActivityRestartAttempt(RunningTaskInfo runningTaskInfo, boolean z, boolean z2) throws RemoteException {
    ...
    public void onActivityLaunchOnSecondaryDisplayFailed(RunningTaskInfo runningTaskInfo, int i) throws RemoteException {
        this.mHandler.obtainMessage(11, i, 0, runningTaskInfo).sendToTarget();
    }

    public void onActivityLaunchOnSecondaryDisplayRerouted(RunningTaskInfo runningTaskInfo, int i) throws RemoteException {
    ...
    public void onTaskMovedToFront(RunningTaskInfo runningTaskInfo) throws RemoteException {
        this.mHandler.obtainMessage(14, runningTaskInfo).sendToTarget();
    }

    public void onBackPressedOnTaskRoot(RunningTaskInfo runningTaskInfo) throws RemoteException {
