...
public class SuperStatusBarViewFactory {
    ...
    private final Builder mNotificationRowComponentBuilder;
    private NotificationShadeWindowView mNotificationShadeWindowView;
    private NotificationShelf mNotificationShelf;
    private StatusBarWindowView mStatusBarWindowView;

    public SuperStatusBarViewFactory(Context context, InjectionInflationController injectionInflationController, Builder builder, LockscreenLockIconController lockscreenLockIconController) {
    ...
    public NotificationShadeWindowView getNotificationShadeWindowView() {
        ...
        NotificationShadeWindowView notificationShadeWindowView2 = (NotificationShadeWindowView) this.mInjectionInflationController.injectable(LayoutInflater.from(this.mContext)).inflate(C2013R$layout.super_notification_shade, null);
        this.mNotificationShadeWindowView = notificationShadeWindowView2;
        if (notificationShadeWindowView2 != null) {
            LockIcon lockIcon = (LockIcon) notificationShadeWindowView2.findViewById(C2011R$id.lock_icon);
            if (lockIcon != null) {
    ...
    public StatusBarWindowView getStatusBarWindowView() {
        ...
        StatusBarWindowView statusBarWindowView2 = (StatusBarWindowView) this.mInjectionInflationController.injectable(LayoutInflater.from(this.mContext)).inflate(C2013R$layout.super_status_bar, null);
    ...
    public NotificationShelf getNotificationShelf(ViewGroup viewGroup) {
        ...
        NotificationShelf notificationShelf2 = (NotificationShelf) this.mInjectionInflationController.injectable(LayoutInflater.from(this.mContext)).inflate(C2013R$layout.status_bar_notification_shelf, viewGroup, false);
