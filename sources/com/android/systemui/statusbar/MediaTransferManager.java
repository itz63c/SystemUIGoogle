...
public class MediaTransferManager {
    ...
    private final DeviceCallback mMediaDeviceCallback = new DeviceCallback() {
    ...
    private final OnClickListener mOnClickHandler = new OnClickListener() {
        ...
        private boolean handleMediaTransfer(View view) {
            if (view.findViewById(16909136) == null) {
                return false;
            }
            String str = "com.android.settings.panel.extra.PACKAGE_NAME";
            MediaTransferManager.this.mActivityStarter.startActivity(new Intent().setAction("com.android.settings.panel.action.MEDIA_OUTPUT").putExtra(str, MediaTransferManager.this.getRowForParent(view.getParent()).getEntry().getSbn().getPackageName()), false, true, 268468224);
            return true;
        }
    };
    ...
    public void setRemoved(View view) {
        if (FeatureFlagUtils.isEnabled(this.mContext, "settings_seamless_transfer") && this.mLocalMediaManager != null && view != null) {
            View findViewById = view.findViewById(16909136);
    ...
    public void applyMediaTransferView(ViewGroup viewGroup, NotificationEntry notificationEntry) {
        if (!(!FeatureFlagUtils.isEnabled(this.mContext, "settings_seamless_transfer") || this.mLocalMediaManager == null || viewGroup == null)) {
            View findViewById = viewGroup.findViewById(16909136);
    ...
    private void updateChip(View view) {
        ...
        ImageView imageView = (ImageView) view.findViewById(16909137);
        TextView textView = (TextView) view.findViewById(16909138);
