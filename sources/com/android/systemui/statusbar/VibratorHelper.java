...
public class VibratorHelper {
    private static final AudioAttributes STATUS_BAR_VIBRATION_ATTRIBUTES = new Builder().setContentType(4).setUsage(13).build();
    ...
    public VibratorHelper(Context context) {
        ...
        this.mContext.getContentResolver().registerContentObserver(System.getUriFor("haptic_feedback_enabled"), true, this.mVibrationObserver);
