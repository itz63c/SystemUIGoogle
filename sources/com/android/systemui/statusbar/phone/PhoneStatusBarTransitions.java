...
public final class PhoneStatusBarTransitions extends BarTransitions {
    ...
    public PhoneStatusBarTransitions(PhoneStatusBarView phoneStatusBarView, View view) {
        super(view, C2010R$drawable.status_background);
        this.mIconAlphaWhenOpaque = phoneStatusBarView.getContext().getResources().getFraction(C2009R$dimen.status_bar_icon_drawing_alpha, 1, 1);
        this.mLeftSide = phoneStatusBarView.findViewById(C2011R$id.status_bar_left_side);
        this.mStatusIcons = phoneStatusBarView.findViewById(C2011R$id.statusIcons);
        this.mBattery = phoneStatusBarView.findViewById(C2011R$id.battery);
