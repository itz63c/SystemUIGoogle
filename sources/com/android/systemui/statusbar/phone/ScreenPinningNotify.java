...
public class ScreenPinningNotify {
    ...
    public void showPinningStartToast() {
        makeAllUserToastAndShow(C2017R$string.screen_pinning_start);
    }

    public void showPinningExitToast() {
        makeAllUserToastAndShow(C2017R$string.screen_pinning_exit);
    }
    ...
    public void showEscapeToast(boolean z, boolean z2) {
        ...
        if (z) {
            i = C2017R$string.screen_pinning_toast_gesture_nav;
        } else if (z2) {
            i = C2017R$string.screen_pinning_toast;
        } else {
            i = C2017R$string.screen_pinning_toast_recents_invisible;
        }
