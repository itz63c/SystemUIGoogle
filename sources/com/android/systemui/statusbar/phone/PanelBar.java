    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (!panelEnabled()) {
            if (motionEvent.getAction() == 0) {
                Log.v(str, String.format("onTouch: all panels disabled, ignoring touch at (%d,%d)", new Object[]{Integer.valueOf((int) motionEvent.getX()), Integer.valueOf((int) motionEvent.getY())}));
            }
            return false;
        }
        if (motionEvent.getAction() == 0) {
            PanelViewController panelViewController = this.mPanel;
            if (panelViewController == null) {
                Log.v(str, String.format("onTouch: no panel for touch at (%d,%d)", new Object[]{Integer.valueOf((int) motionEvent.getX()), Integer.valueOf((int) motionEvent.getY())}));
                return true;
            } else if (!panelViewController.isEnabled()) {
                Log.v(str, String.format("onTouch: panel (%s) is disabled, ignoring touch at (%d,%d)", new Object[]{panelViewController, Integer.valueOf((int) motionEvent.getX()), Integer.valueOf((int) motionEvent.getY())}));
                return true;
            }
        }
