...
public class CollapsedStatusBarFragment extends Fragment implements Callbacks, StateListener {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        return layoutInflater.inflate(C2013R$layout.status_bar, viewGroup, false);
    }
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        DarkIconManager darkIconManager = new DarkIconManager((LinearLayout) view.findViewById(C2011R$id.statusIcons), (CommandQueue) Dependency.get(CommandQueue.class));
        ...
        this.mSystemIconArea = (LinearLayout) this.mStatusBar.findViewById(C2011R$id.system_icon_area);
        this.mClockView = this.mStatusBar.findViewById(C2011R$id.clock);
    ...
    public void initNotificationIconArea(NotificationIconAreaController notificationIconAreaController) {
        ViewGroup viewGroup = (ViewGroup) this.mStatusBar.findViewById(C2011R$id.notification_icon_area);
        ...
        ViewGroup viewGroup2 = (ViewGroup) this.mStatusBar.findViewById(C2011R$id.centered_icon_area);
    ...
    private void initEmergencyCryptkeeperText() {
        View findViewById = this.mStatusBar.findViewById(C2011R$id.emergency_cryptkeeper_text);
        if (this.mNetworkController.hasEmergencyCryptKeeperText()) {
    ...
    private void initOperatorName() {
        if (getResources().getBoolean(C2007R$bool.config_showOperatorNameInStatusBar)) {
            this.mOperatorNameFrame = ((ViewStub) this.mStatusBar.findViewById(C2011R$id.operator_name)).inflate();
        }
    }
