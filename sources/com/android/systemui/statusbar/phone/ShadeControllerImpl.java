...
public class ShadeControllerImpl implements ShadeController {
    ...
    public void animateCollapsePanels(int i, boolean z, boolean z2, float f) {
        if (z || this.mStatusBarStateController.getState() == 0) {
            ...
            sb.append(getNotificationShadeWindowView());
            sb.append(" canPanelBeCollapsed(): ");
            sb.append(getNotificationPanelViewController().canPanelBeCollapsed());
            ...
            if (getNotificationShadeWindowView() == null || !getNotificationPanelViewController().canPanelBeCollapsed()) {
                ((BubbleController) this.mBubbleControllerLazy.get()).collapseStack();
            } else {
    ...
    public void postOnShadeExpanded(final Runnable runnable) {
        getNotificationPanelViewController().addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
    ...
    public StatusBar getStatusBar() {
        return (StatusBar) this.mStatusBarLazy.get();
    }
