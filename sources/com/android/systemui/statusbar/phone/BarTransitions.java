...
public class BarTransitions {
    ...
    protected static class BarBackgroundDrawable extends Drawable {
        ...
        public BarBackgroundDrawable(Context context, int i) {
            ...
            this.mOpaque = context.getColor(C2008R$color.system_bar_background_opaque);
            this.mSemiTransparent = context.getColor(17170987);
            this.mTransparent = context.getColor(C2008R$color.system_bar_background_transparent);
