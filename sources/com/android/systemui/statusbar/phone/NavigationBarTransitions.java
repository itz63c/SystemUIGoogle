...
public final class NavigationBarTransitions extends BarTransitions implements DarkIntensityApplier {
        ...
        public void onWallpaperVisibilityChanged(boolean z, int i) throws RemoteException {
            ...
            NavigationBarTransitions.this.mHandler.post(new Runnable() {
                public final void run() {
                    C15101.this.lambda$onWallpaperVisibilityChanged$0$NavigationBarTransitions$1();
                }
            });
        }
    ...
    public NavigationBarTransitions(NavigationBarView navigationBarView, CommandQueue commandQueue) {
        super(navigationBarView, C2010R$drawable.nav_background);
        ...
        this.mAllowAutoDimWallpaperNotVisible = navigationBarView.getContext().getResources().getBoolean(C2007R$bool.config_navigation_bar_enable_auto_dim_no_visible_wallpaper);
        ...
        if (currentView != null) {
            this.mNavButtons = currentView.findViewById(C2011R$id.nav_buttons);
        }
    }
    ...
    public int getTintAnimationDuration() {
        return Utils.isGesturalModeOnDefaultDisplay(this.mView.getContext(), this.mNavBarMode) ? Math.max(1700, 400) : R$styleable.AppCompatTheme_windowFixedWidthMajor;
    }
