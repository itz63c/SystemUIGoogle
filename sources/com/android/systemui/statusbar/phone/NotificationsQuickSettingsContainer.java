...
public class NotificationsQuickSettingsContainer extends FrameLayout implements OnInflateListener, FragmentListener, HasViewAboveShelfChangedListener {
    ...
    public void onFinishInflate() {
        ...
        this.mQsFrame = (FrameLayout) findViewById(C2011R$id.qs_frame);
        NotificationStackScrollLayout notificationStackScrollLayout = (NotificationStackScrollLayout) findViewById(C2011R$id.notification_stack_scroller);
        this.mStackScroller = notificationStackScrollLayout;
        this.mStackScrollerMargin = ((LayoutParams) notificationStackScrollLayout.getLayoutParams()).bottomMargin;
        this.mKeyguardStatusBar = findViewById(C2011R$id.keyguard_header);
        ViewStub viewStub = (ViewStub) findViewById(C2011R$id.keyguard_user_switcher);
    ...
    public void onAttachedToWindow() {
        ...
        FragmentHostManager.get(this).addTagListener(C0940QS.TAG, this);
    }

    /* access modifiers changed from: protected */
    public void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        FragmentHostManager.get(this).removeTagListener(C0940QS.TAG, this);
    }

    /* access modifiers changed from: protected */
    public void onConfigurationChanged(Configuration configuration) {
        super.onConfigurationChanged(configuration);
        reloadWidth(this.mQsFrame, C2009R$dimen.qs_panel_width);
        reloadWidth(this.mStackScroller, C2009R$dimen.notification_panel_width);
    }
    ...
    public void onFragmentViewCreated(String str, Fragment fragment) {
        ((C0940QS) fragment).setContainer(this);
    }
