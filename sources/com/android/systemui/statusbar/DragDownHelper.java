...
public class DragDownHelper implements Gefingerpoken {
    ...
    public DragDownHelper(Context context, View view, Callback callback, DragDownCallback dragDownCallback, FalsingManager falsingManager) {
        this.mMinDragDistance = context.getResources().getDimensionPixelSize(C2009R$dimen.keyguard_drag_down_min_distance);
