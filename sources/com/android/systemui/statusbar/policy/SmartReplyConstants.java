...
public final class SmartReplyConstants {
    ...
    private final OnPropertiesChangedListener mOnPropertiesChangedListener = new OnPropertiesChangedListener() {
        public void onPropertiesChanged(Properties properties) {
            if (!"systemui".equals(properties.getNamespace())) {
                ...
                sb.append(properties.getNamespace());
    ...
    public SmartReplyConstants(Handler handler, Context context, DeviceConfigProxy deviceConfigProxy) {
        ...
        this.mDefaultEnabled = resources.getBoolean(C2007R$bool.config_smart_replies_in_notifications_enabled);
        this.mDefaultRequiresP = resources.getBoolean(C2007R$bool.config_smart_replies_in_notifications_requires_targeting_p);
        this.mDefaultMaxSqueezeRemeasureAttempts = resources.getInteger(C2012R$integer.f29xb8282359);
        this.mDefaultEditChoicesBeforeSending = resources.getBoolean(C2007R$bool.f26xa48abd95);
        this.mDefaultShowInHeadsUp = resources.getBoolean(C2007R$bool.config_smart_replies_in_notifications_show_in_heads_up);
        this.mDefaultMinNumSystemGeneratedReplies = resources.getInteger(C2012R$integer.f30xce369515);
        this.mDefaultMaxNumActions = resources.getInteger(C2012R$integer.config_smart_replies_in_notifications_max_num_actions);
        this.mDefaultOnClickInitDelay = resources.getInteger(C2012R$integer.config_smart_replies_in_notifications_onclick_init_delay);
