...
public class DeadZone {
    ...
    public void onConfigurationChanged(int i) {
        ...
        this.mHold = resources.getInteger(C2012R$integer.navigation_bar_deadzone_hold);
        this.mDecay = resources.getInteger(C2012R$integer.navigation_bar_deadzone_decay);
        this.mSizeMin = resources.getDimensionPixelSize(C2009R$dimen.navigation_bar_deadzone_size);
        this.mSizeMax = resources.getDimensionPixelSize(C2009R$dimen.navigation_bar_deadzone_size_max);
        boolean z = true;
        if (resources.getInteger(C2012R$integer.navigation_bar_deadzone_orientation) != 1) {
            z = false;
        }
        this.mVertical = z;
        setFlashOnTouchCapture(resources.getBoolean(C2007R$bool.config_dead_zone_flash));
    }
