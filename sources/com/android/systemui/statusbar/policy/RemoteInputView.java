...
public class RemoteInputView extends LinearLayout implements OnClickListener, TextWatcher {
    ...
    public static class RemoteEditText extends EditText {
        ...
        public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
            EditorInfoCompat.setContentMimeTypes(editorInfo, (String[]) this.mRemoteInputView.mRemoteInput.getAllowedDataTypes().toArray(new String[0]));
            InputConnection onCreateInputConnection = super.onCreateInputConnection(editorInfo);
            Context context = null;
            InputConnection createWrapper = onCreateInputConnection == null ? null : InputConnectionCompat.createWrapper(onCreateInputConnection, editorInfo, new OnCommitContentListener() {
            ...
            try {
                ...
                Log.e("RemoteInput", sb.toString(), e);
            }
    ...
    public void onFinishInflate() {
        ...
        this.mProgressBar = (ProgressBar) findViewById(C2011R$id.remote_input_progress);
        ImageButton imageButton = (ImageButton) findViewById(C2011R$id.remote_input_send);
    ...
    public Intent prepareRemoteInputFromData(String str, Uri uri) {
        ...
        this.mEntry.remoteInputText = this.mContext.getString(C2017R$string.remote_input_image_insertion_text);
        NotificationEntry notificationEntry = this.mEntry;
    ...
    public static RemoteInputView inflate(Context context, ViewGroup viewGroup, NotificationEntry notificationEntry, RemoteInputController remoteInputController) {
        RemoteInputView remoteInputView = (RemoteInputView) LayoutInflater.from(context).inflate(C2013R$layout.remote_input, viewGroup, false);
