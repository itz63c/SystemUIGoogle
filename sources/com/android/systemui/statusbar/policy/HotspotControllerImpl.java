...
public class HotspotControllerImpl implements HotspotController, SoftApCallback {
    ...
    private TetheringEventCallback mTetheringCallback = new TetheringEventCallback() {
        ...
        public void onTetherableInterfaceRegexpsChanged(TetheringInterfaceRegexps tetheringInterfaceRegexps) {
    ...
    public void setHotspotEnabled(boolean z) {
        ...
        if (z) {
            ...
            this.mTetheringManager.startTethering(new Builder(0).build(), ConcurrentUtils.DIRECT_EXECUTOR, new StartTetheringCallback() {
    ...
    public void fireHotspotChangedCallback() {
        ...
        for (Callback onHotspotChanged : arrayList) {
    ...
    public void fireHotspotAvailabilityChanged() {
        ...
        for (Callback onHotspotAvailabilityChanged : arrayList) {
