...
public final class NotificationWakeUpCoordinator implements OnHeadsUpChangedListener, StateListener, PanelExpansionListener {
    ...
    public NotificationWakeUpCoordinator(HeadsUpManager headsUpManager, StatusBarStateController statusBarStateController2, KeyguardBypassController keyguardBypassController, DozeParameters dozeParameters2) {
    ...
    private final void setNotificationsFullyHidden(boolean z) {
        if (this.notificationsFullyHidden != z) {
            ...
            while (it.hasNext()) {
                ((WakeUpListener) it.next()).onFullyHiddenChanged(z);
            }
        }
    }
