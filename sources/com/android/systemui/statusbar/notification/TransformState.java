...
public class TransformState {
    private static ClippingParameters CLIPPING_PARAMETERS = new ClippingParameters() {
    ...
    private static final int TRANSFORMATION_START_SCLALE_X = C2011R$id.transformation_start_scale_x_tag;
    private static final int TRANSFORMATION_START_SCLALE_Y = C2011R$id.transformation_start_scale_y_tag;
    private static final int TRANSFORMATION_START_X = C2011R$id.transformation_start_x_tag;
    private static final int TRANSFORMATION_START_Y = C2011R$id.transformation_start_y_tag;
    ...
    public void transformViewFullyFrom(TransformState transformState, CustomTransformation customTransformation, float f) {
        transformViewFrom(transformState, 17, customTransformation, f);
    }

    public void transformViewVerticalFrom(TransformState transformState, CustomTransformation customTransformation, float f) {
    ...
    public void transformViewFullyTo(TransformState transformState, CustomTransformation customTransformation, float f) {
        transformViewTo(transformState, 17, customTransformation, f);
    }

    public void transformViewVerticalTo(TransformState transformState, CustomTransformation customTransformation, float f) {
    ...
    private void transformViewTo(TransformState transformState, int i, CustomTransformation customTransformation, float f) {
        float f2;
        float f3;
        TransformState transformState2 = transformState;
        CustomTransformation customTransformation2 = customTransformation;
        float f4 = f;
