...
public final class NotificationsModule_ProvideNotificationEntryManagerFactory implements Factory<NotificationEntryManager> {
    ...
    private final Provider<KeyguardEnvironment> keyguardEnvironmentProvider;
    ...
    public NotificationsModule_ProvideNotificationEntryManagerFactory(Provider<NotificationEntryManagerLogger> provider, Provider<NotificationGroupManager> provider2, Provider<NotificationRankingManager> provider3, Provider<KeyguardEnvironment> provider4, Provider<FeatureFlags> provider5, Provider<NotificationRowBinder> provider6, Provider<NotificationRemoteInputManager> provider7, Provider<LeakDetector> provider8, Provider<ForegroundServiceDismissalFeatureController> provider9) {
    ...
    public static NotificationEntryManager provideInstance(Provider<NotificationEntryManagerLogger> provider, Provider<NotificationGroupManager> provider2, Provider<NotificationRankingManager> provider3, Provider<KeyguardEnvironment> provider4, Provider<FeatureFlags> provider5, Provider<NotificationRowBinder> provider6, Provider<NotificationRemoteInputManager> provider7, Provider<LeakDetector> provider8, Provider<ForegroundServiceDismissalFeatureController> provider9) {
        return proxyProvideNotificationEntryManager((NotificationEntryManagerLogger) provider.get(), (NotificationGroupManager) provider2.get(), (NotificationRankingManager) provider3.get(), (KeyguardEnvironment) provider4.get(), (FeatureFlags) provider5.get(), DoubleCheck.lazy(provider6), DoubleCheck.lazy(provider7), (LeakDetector) provider8.get(), (ForegroundServiceDismissalFeatureController) provider9.get());
    }

    public static NotificationsModule_ProvideNotificationEntryManagerFactory create(Provider<NotificationEntryManagerLogger> provider, Provider<NotificationGroupManager> provider2, Provider<NotificationRankingManager> provider3, Provider<KeyguardEnvironment> provider4, Provider<FeatureFlags> provider5, Provider<NotificationRowBinder> provider6, Provider<NotificationRemoteInputManager> provider7, Provider<LeakDetector> provider8, Provider<ForegroundServiceDismissalFeatureController> provider9) {
        NotificationsModule_ProvideNotificationEntryManagerFactory notificationsModule_ProvideNotificationEntryManagerFactory = new NotificationsModule_ProvideNotificationEntryManagerFactory(provider, provider2, provider3, provider4, provider5, provider6, provider7, provider8, provider9);
        return notificationsModule_ProvideNotificationEntryManagerFactory;
    }

    public static NotificationEntryManager proxyProvideNotificationEntryManager(NotificationEntryManagerLogger notificationEntryManagerLogger, NotificationGroupManager notificationGroupManager, NotificationRankingManager notificationRankingManager, KeyguardEnvironment keyguardEnvironment, FeatureFlags featureFlags, Lazy<NotificationRowBinder> lazy, Lazy<NotificationRemoteInputManager> lazy2, LeakDetector leakDetector, ForegroundServiceDismissalFeatureController foregroundServiceDismissalFeatureController) {
