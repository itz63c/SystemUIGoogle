...
public class ViewState implements Dumpable {
    ...
    private static final AnimatableProperty SCALE_X_PROPERTY = new AnimatableProperty() {
        public int getAnimationStartTag() {
            return C2011R$id.scale_x_animator_start_value_tag;
        }

        public int getAnimationEndTag() {
            return C2011R$id.scale_x_animator_end_value_tag;
        }

        public int getAnimatorTag() {
            return C2011R$id.scale_x_animator_tag;
        }
    ...
    private static final AnimatableProperty SCALE_Y_PROPERTY = new AnimatableProperty() {
        public int getAnimationStartTag() {
            return C2011R$id.scale_y_animator_start_value_tag;
        }

        public int getAnimationEndTag() {
            return C2011R$id.scale_y_animator_end_value_tag;
        }

        public int getAnimatorTag() {
            return C2011R$id.scale_y_animator_tag;
        }
    ...
    public static final int TAG_ANIMATOR_ALPHA = C2011R$id.alpha_animator_tag;
    /* access modifiers changed from: private */
    public static final int TAG_ANIMATOR_TRANSLATION_X = C2011R$id.translation_x_animator_tag;
    /* access modifiers changed from: private */
    public static final int TAG_ANIMATOR_TRANSLATION_Y = C2011R$id.translation_y_animator_tag;
    /* access modifiers changed from: private */
    public static final int TAG_ANIMATOR_TRANSLATION_Z = C2011R$id.translation_z_animator_tag;
    /* access modifiers changed from: private */
    public static final int TAG_END_ALPHA = C2011R$id.alpha_animator_end_value_tag;
    /* access modifiers changed from: private */
    public static final int TAG_END_TRANSLATION_X = C2011R$id.translation_x_animator_end_value_tag;
    /* access modifiers changed from: private */
    public static final int TAG_END_TRANSLATION_Y = C2011R$id.translation_y_animator_end_value_tag;
    /* access modifiers changed from: private */
    public static final int TAG_END_TRANSLATION_Z = C2011R$id.translation_z_animator_end_value_tag;
    /* access modifiers changed from: private */
    public static final int TAG_START_ALPHA = C2011R$id.alpha_animator_start_value_tag;
    /* access modifiers changed from: private */
    public static final int TAG_START_TRANSLATION_X = C2011R$id.translation_x_animator_start_value_tag;
    /* access modifiers changed from: private */
    public static final int TAG_START_TRANSLATION_Y = C2011R$id.translation_y_animator_start_value_tag;
    /* access modifiers changed from: private */
    public static final int TAG_START_TRANSLATION_Z = C2011R$id.translation_z_animator_start_value_tag;
    public float alpha;
    public boolean gone;
    ...
    public void applyToView(View view) {
        if (!this.gone) {
            ...
            if (i != visibility && (!(view instanceof ExpandableView) || !((ExpandableView) view).willBeGone())) {
        ...
        if (f2 == null || f2.floatValue() != f3) {
            ...
            if (!animationProperties.getAnimationFilter().animateAlpha) {
                if (objectAnimator != null) {
                    ...
                    objectAnimator.getValues()[0].setFloatValues(new float[]{floatValue, f3});
