...
class NotificationSwipeHelper extends SwipeHelper implements NotificationSwipeActionHelper {
    ...
    private final OnMenuEventListener mMenuListener;
    ...
    public interface NotificationCallback extends Callback {
        ...
        void onSnooze(StatusBarNotification statusBarNotification, SnoozeOption snoozeOption);

        boolean shouldDismissQuickly();
    }

    NotificationSwipeHelper(int i, NotificationCallback notificationCallback, Context context, OnMenuEventListener onMenuEventListener, FalsingManager falsingManager) {
    ...
    public void snooze(StatusBarNotification statusBarNotification, SnoozeOption snoozeOption) {
    ...
    /* access modifiers changed from: protected */
    @VisibleForTesting
    public Animator superGetViewTranslationAnimator(View view, float f, AnimatorUpdateListener animatorUpdateListener) {
        return super.getViewTranslationAnimator(view, f, animatorUpdateListener);
    }

    public Animator getViewTranslationAnimator(View view, float f, AnimatorUpdateListener animatorUpdateListener) {
    ...
    public boolean shouldResetMenu(boolean z) {
        ...
        return view != null && (z || view != this.mTranslatingParentView);
    }
    ...
    public static boolean isTouchInView(MotionEvent motionEvent, View view) {
        ...
        int i2 = iArr[0];
        int i3 = iArr[1];
        return new Rect(i2, i3, view.getWidth() + i2, i + i3).contains(rawX, rawY);
    }
