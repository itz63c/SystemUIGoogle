...
class NotificationSection {
    ...
    public boolean setFirstVisibleChild(ActivatableNotificationView activatableNotificationView) {
        boolean z = this.mFirstVisibleChild != activatableNotificationView;
        this.mFirstVisibleChild = activatableNotificationView;
        return z;
    }

    public boolean setLastVisibleChild(ActivatableNotificationView activatableNotificationView) {
        boolean z = this.mLastVisibleChild != activatableNotificationView;
    ...
    public int updateBounds(int i, int i2, boolean z) {
        ...
        ActivatableNotificationView lastVisibleChild = getLastVisibleChild();
