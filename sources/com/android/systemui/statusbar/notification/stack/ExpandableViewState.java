...
public class ExpandableViewState extends ViewState {
    ...
    public static final int TAG_ANIMATOR_HEIGHT = C2011R$id.height_animator_tag;
    /* access modifiers changed from: private */
    public static final int TAG_ANIMATOR_TOP_INSET = C2011R$id.top_inset_animator_tag;
    /* access modifiers changed from: private */
    public static final int TAG_END_HEIGHT = C2011R$id.height_animator_end_value_tag;
    /* access modifiers changed from: private */
    public static final int TAG_END_TOP_INSET = C2011R$id.top_inset_animator_end_value_tag;
    /* access modifiers changed from: private */
    public static final int TAG_START_HEIGHT = C2011R$id.height_animator_start_value_tag;
    /* access modifiers changed from: private */
    public static final int TAG_START_TOP_INSET = C2011R$id.top_inset_animator_start_value_tag;
    ...
    public void applyToView(View view) {
        ...
        if (view instanceof ExpandableView) {
            ...
            float clipTopAmount2 = (float) expandableView.getClipTopAmount();
            int i2 = this.clipTopAmount;
            if (clipTopAmount2 != ((float) i2)) {
    ...
    private void startHeightAnimation(final ExpandableView expandableView, AnimationProperties animationProperties) {
        ...
        if (num2 == null || num2.intValue() != i4) {
            ...
            if (animationProperties.getAnimationFilter().animateHeight) {
                ...
                valueAnimator.getValues()[0].setIntValues(new int[]{intValue, i4});
