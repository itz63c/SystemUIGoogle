...
public class AmbientState {
    ...
    public AmbientState(Context context, SectionProvider sectionProvider, HeadsUpManager headsUpManager) {
    ...
    private static int getZDistanceBetweenElements(Context context) {
        return Math.max(1, context.getResources().getDimensionPixelSize(C2009R$dimen.z_distance_between_notifications));
    }
    ...
    public boolean hasPulsingNotifications() {
        if (this.mPulsing) {
            HeadsUpManager headsUpManager = this.mHeadUpManager;
            if (headsUpManager != null && headsUpManager.hasNotifications()) {
                return true;
            }
        }
        return false;
