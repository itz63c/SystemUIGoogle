...
public class ImageGradientColorizer {
    public Bitmap colorize(Drawable drawable, int i, boolean z) {
        ...
        float f3 = (float) min;
        LinearGradient linearGradient = new LinearGradient(0.0f, 0.0f, f3, 0.0f, new int[]{0, Color.argb(0.5f, 1.0f, 1.0f, 1.0f), -16777216}, new float[]{0.0f, 0.4f, 1.0f}, TileMode.CLAMP);
        ...
        LinearGradient linearGradient2 = new LinearGradient(0.0f, 0.0f, f3, 0.0f, new int[]{0, Color.argb(0.5f, 1.0f, 1.0f, 1.0f), -16777216}, new float[]{0.0f, 0.6f, 1.0f}, TileMode.CLAMP);
        paint.setShader(linearGradient2);
        canvas2.drawPaint(paint);
        canvas.drawBitmap(createBitmap2, 0.0f, 0.0f, null);
        return createBitmap;
    }
}
