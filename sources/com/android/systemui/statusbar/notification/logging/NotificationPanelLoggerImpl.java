...
public class NotificationPanelLoggerImpl implements NotificationPanelLogger {
    public void logPanelShown(boolean z, List<NotificationEntry> list) {
        ...
        SysUiStatsLog.write(245, NotificationPanelEvent.fromLockscreen(z).getId(), notificationProto.notifications.length, MessageNano.toByteArray(notificationProto));
    }
}
