...
public class BubbleCoordinator implements Coordinator {
    ...
    public final NotifDismissInterceptor mDismissInterceptor = new NotifDismissInterceptor() {
        ...
        public void setCallback(OnEndDismissInterception onEndDismissInterception) {
    ...
    private final NotifCallback mNotifCallback = new NotifCallback() {
    ...
    /* access modifiers changed from: private */
    public OnEndDismissInterception mOnEndDismissInterception;
