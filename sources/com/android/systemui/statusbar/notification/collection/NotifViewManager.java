...
public final class NotifViewManager {
    ...
    public NotifViewManager(NotifViewBarn notifViewBarn, VisualStabilityManager visualStabilityManager, FeatureFlags featureFlags2) {
    ...
    public final void setViewConsumer(SimpleNotificationListContainer simpleNotificationListContainer) {
    ...
    public final void onNotifTreeBuilt(List<? extends ListEntry> list) {
    ...
    private final void detachRows(java.util.List<? extends com.android.systemui.statusbar.notification.collection.ListEntry> r11) {
        ...
        L_0x0081:
            ...
            kotlin.jvm.internal.Intrinsics.checkExpressionValueIsNotNull(r4, r5)
            java.util.List r5 = r3.getNotificationChildren()
    ...
    private final void attachRows(List<? extends ListEntry> list) {
        ...
        while (true) {
            boolean z = false;
            while (true) {
                String str = "listContainer";
                Class cls = null;
                if (it.hasNext()) {
                    ListEntry listEntry = (ListEntry) it.next();
                    NotificationListItem requireView = this.rowRegistry.requireView(listEntry);
                    ...
                    if (listEntry instanceof GroupEntry) {
                        ...
                        for (NotificationEntry notificationEntry : children) {
                            ...
                            NotificationListItem requireView2 = notifViewBarn.requireView(notificationEntry);
                            List notificationChildren = requireView.getNotificationChildren();
                            Intrinsics.checkExpressionValueIsNotNull(notificationChildren, "listItem.notificationChildren");
                            if (!CollectionsKt___CollectionsKt.contains(notificationChildren, requireView2)) {
                                View view2 = requireView2.getView();
                                String str2 = "childListItem.view";
                        ...
                        if (z || requireView.applyChildOrder(getChildListFromParent(listEntry), this.stabilityManager, null)) {
                            z = true;
                        }
                    }
                } else if (z) {
