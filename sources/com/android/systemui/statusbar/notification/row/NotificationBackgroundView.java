...
public class NotificationBackgroundView extends View {
    ...
    private final boolean mDontModifyCorners = getResources().getBoolean(C2007R$bool.config_clipNotificationsToOutline);
    ...
    public void setTint(int i) {
        if (i != 0) {
            this.mBackground.setColorFilter(i, Mode.SRC_ATOP);
        } else {
    ...
    public void setExpandAnimationParams(ExpandAnimationParameters expandAnimationParameters) {
    ...
    public void setExpandAnimationRunning(boolean z) {
        ...
        if (drawable instanceof LayerDrawable) {
            ...
            gradientDrawable.setXfermode(z ? new PorterDuffXfermode(Mode.SRC) : null);
