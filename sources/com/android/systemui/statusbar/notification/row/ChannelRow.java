...
public final class ChannelRow extends LinearLayout {
    ...
    public static final /* synthetic */ Switch access$getSwitch$p(ChannelRow channelRow) {
        Switch switchR = channelRow.f106switch;
        if (switchR != null) {
            return switchR;
        }
    ...
    public void onFinishInflate() {
        View findViewById = findViewById(C2011R$id.channel_name);
        ...
        View findViewById2 = findViewById(C2011R$id.channel_description);
    ...
    private final void updateViews() {
        ...
        L_0x005d:
            ...
            r1.setVisibility(r3)
        L_0x0066:
            android.widget.Switch r6 = r6.f106switch
