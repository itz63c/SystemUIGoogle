...
public class NotificationGuts extends FrameLayout {
    ...
    public void onFinishInflate() {
        ...
        Drawable drawable = this.mContext.getDrawable(C2010R$drawable.notification_guts_bg);
    ...
    private void animateOpen(boolean z, int i, int i2, Runnable runnable) {
        if (!isAttachedToWindow()) {
            ...
            float hypot = (float) Math.hypot((double) Math.max(getWidth() - i, i), (double) Math.max(getHeight() - i2, i2));
            setAlpha(1.0f);
            Animator createCircularReveal = ViewAnimationUtils.createCircularReveal(this, i, i2, 0.0f, hypot);
