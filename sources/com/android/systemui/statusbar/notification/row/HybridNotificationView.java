...
public class HybridNotificationView extends AlphaOptimizedLinearLayout implements TransformableView {
    ...
    public void onFinishInflate() {
        ...
        this.mTitleView = (TextView) findViewById(C2011R$id.notification_title);
        this.mTextView = (TextView) findViewById(C2011R$id.notification_text);
        ...
        viewTransformationHelper.setCustomTransformation(new CustomTransformation() {
