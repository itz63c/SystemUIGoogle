...
public final class RowContentBindParams {
    ...
    public void freeContentViews(int i) {
        int i2 = this.mContentViews;
        int i3 = ~i;
        this.mContentViews = i2 & i3;
        this.mDirtyContentViews = i3 & this.mDirtyContentViews;
    ...
    public String toString() {
        return String.format("RowContentBindParams[mContentViews=%x mDirtyContentViews=%x mUseLowPriority=%b mUseChildInGroup=%b mUseIncreasedHeight=%b mUseIncreasedHeadsUpHeight=%b mViewsNeedReinflation=%b]", new Object[]{Integer.valueOf(this.mContentViews), Integer.valueOf(this.mDirtyContentViews), Boolean.valueOf(this.mUseLowPriority), Boolean.valueOf(this.mUseChildInGroup), Boolean.valueOf(this.mUseIncreasedHeight), Boolean.valueOf(this.mUseIncreasedHeadsUpHeight), Boolean.valueOf(this.mViewsNeedReinflation)});
    }
}
