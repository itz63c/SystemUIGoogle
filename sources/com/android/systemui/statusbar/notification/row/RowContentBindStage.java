...
public class RowContentBindStage extends BindStage<RowContentBindParams> {
    ...
    public void executeStage(NotificationEntry notificationEntry, ExpandableNotificationRow expandableNotificationRow, final StageCallback stageCallback) {
        ...
        C12911 r9 = new InflationCallback() {
