...
public abstract class NotificationViewWrapper implements TransformableView {
    ...
    public static NotificationViewWrapper wrap(Context context, View view, ExpandableNotificationRow expandableNotificationRow) {
        if (view.getId() == 16909454) {
            ...
            if (!"media".equals(view.getTag())) {
                if (!"bigMediaNarrow".equals(view.getTag())) {
                    ...
                    if (DecoratedCustomViewStyle.class.equals(expandableNotificationRow.getEntry().getSbn().getNotification().getNotificationStyle())) {
