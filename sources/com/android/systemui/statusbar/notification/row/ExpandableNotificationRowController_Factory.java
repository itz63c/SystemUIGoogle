...
public final class ExpandableNotificationRowController_Factory implements Factory<ExpandableNotificationRowController> {
    ...
    private final Provider<InflationCallback> inflationCallbackProvider;
    ...
    private final Provider<OnExpandClickListener> onExpandClickListenerProvider;
    ...
    public ExpandableNotificationRowController_Factory(Provider<ExpandableNotificationRow> provider, Provider<ActivatableNotificationViewController> provider2, Provider<NotificationMediaManager> provider3, Provider<PluginManager> provider4, Provider<SystemClock> provider5, Provider<String> provider6, Provider<String> provider7, Provider<KeyguardBypassController> provider8, Provider<NotificationGroupManager> provider9, Provider<RowContentBindStage> provider10, Provider<NotificationLogger> provider11, Provider<HeadsUpManager> provider12, Provider<OnExpandClickListener> provider13, Provider<StatusBarStateController> provider14, Provider<InflationCallback> provider15, Provider<NotificationGutsManager> provider16, Provider<Boolean> provider17, Provider<Runnable> provider18, Provider<FalsingManager> provider19) {
        ...
        this.inflationCallbackProvider = provider15;
        this.notificationGutsManagerProvider = provider16;
        this.allowLongPressProvider = provider17;
        this.onDismissRunnableProvider = provider18;
    ...
    public static ExpandableNotificationRowController provideInstance(Provider<ExpandableNotificationRow> provider, Provider<ActivatableNotificationViewController> provider2, Provider<NotificationMediaManager> provider3, Provider<PluginManager> provider4, Provider<SystemClock> provider5, Provider<String> provider6, Provider<String> provider7, Provider<KeyguardBypassController> provider8, Provider<NotificationGroupManager> provider9, Provider<RowContentBindStage> provider10, Provider<NotificationLogger> provider11, Provider<HeadsUpManager> provider12, Provider<OnExpandClickListener> provider13, Provider<StatusBarStateController> provider14, Provider<InflationCallback> provider15, Provider<NotificationGutsManager> provider16, Provider<Boolean> provider17, Provider<Runnable> provider18, Provider<FalsingManager> provider19) {
        ExpandableNotificationRowController expandableNotificationRowController = new ExpandableNotificationRowController((ExpandableNotificationRow) provider.get(), (ActivatableNotificationViewController) provider2.get(), (NotificationMediaManager) provider3.get(), (PluginManager) provider4.get(), (SystemClock) provider5.get(), (String) provider6.get(), (String) provider7.get(), (KeyguardBypassController) provider8.get(), (NotificationGroupManager) provider9.get(), (RowContentBindStage) provider10.get(), (NotificationLogger) provider11.get(), (HeadsUpManager) provider12.get(), (OnExpandClickListener) provider13.get(), (StatusBarStateController) provider14.get(), (InflationCallback) provider15.get(), (NotificationGutsManager) provider16.get(), ((Boolean) provider17.get()).booleanValue(), (Runnable) provider18.get(), (FalsingManager) provider19.get());
    ...
    public static ExpandableNotificationRowController_Factory create(Provider<ExpandableNotificationRow> provider, Provider<ActivatableNotificationViewController> provider2, Provider<NotificationMediaManager> provider3, Provider<PluginManager> provider4, Provider<SystemClock> provider5, Provider<String> provider6, Provider<String> provider7, Provider<KeyguardBypassController> provider8, Provider<NotificationGroupManager> provider9, Provider<RowContentBindStage> provider10, Provider<NotificationLogger> provider11, Provider<HeadsUpManager> provider12, Provider<OnExpandClickListener> provider13, Provider<StatusBarStateController> provider14, Provider<InflationCallback> provider15, Provider<NotificationGutsManager> provider16, Provider<Boolean> provider17, Provider<Runnable> provider18, Provider<FalsingManager> provider19) {
        ExpandableNotificationRowController_Factory expandableNotificationRowController_Factory = new ExpandableNotificationRowController_Factory(provider, provider2, provider3, provider4, provider5, provider6, provider7, provider8, provider9, provider10, provider11, provider12, provider13, provider14, provider15, provider16, provider17, provider18, provider19);
        return expandableNotificationRowController_Factory;
    }
}
