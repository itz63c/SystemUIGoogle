...
public class KeyguardAffordanceView extends ImageView {
    ...
    public void updateIconColor() {
        if (this.mShouldTint) {
            getDrawable().mutate().setColorFilter(((Integer) this.mColorInterpolator.evaluate(Math.min(1.0f, this.mCircleRadius / ((float) this.mMinBackgroundRadius)), Integer.valueOf(this.mNormalColor), Integer.valueOf(this.mDarkIconColor))).intValue(), Mode.SRC_ATOP);
        }
    }
    ...
    private void drawBackgroundCircle(Canvas canvas) {
        if (this.mCircleRadius > 0.0f || this.mFinishing) {
            if (this.mFinishing && this.mSupportHardware) {
                CanvasProperty<Float> canvasProperty = this.mHwCenterX;
    ...
    public void setImageAlpha(float f, boolean z, long j, Interpolator interpolator, Runnable runnable) {
        ...
        ofInt.addUpdateListener(new AnimatorUpdateListener(background) {
