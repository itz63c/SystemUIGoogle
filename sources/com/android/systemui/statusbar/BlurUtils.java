...
public class BlurUtils implements Dumpable {
    ...
    private final int maxBlurRadius = this.resources.getDimensionPixelSize(C2009R$dimen.max_window_blur_radius);
    private final int minBlurRadius;
    private final Resources resources;

    public BlurUtils(Resources resources2, DumpManager dumpManager) {
        Intrinsics.checkParameterIsNotNull(resources2, "resources");
        Intrinsics.checkParameterIsNotNull(dumpManager, "dumpManager");
        this.resources = resources2;
        this.minBlurRadius = resources2.getDimensionPixelSize(C2009R$dimen.min_window_blur_radius);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:14:0x0030, code lost:
        kotlin.p014io.CloseableKt.closeFinally(r2, r3);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:15:0x0033, code lost:
        throw r4;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final void applyBlur(android.view.ViewRootImpl r3, int r4) {
        /*
            r2 = this;
        ...
        L_0x0018:
            ...
            kotlin.p014io.CloseableKt.closeFinally(r2, r0)
            return
        L_0x002d:
            r3 = move-exception
