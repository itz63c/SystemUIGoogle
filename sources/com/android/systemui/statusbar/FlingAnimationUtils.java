...
public class FlingAnimationUtils {
    ...
    public static class Builder {
        ...
        public FlingAnimationUtils build() {
            FlingAnimationUtils flingAnimationUtils = new FlingAnimationUtils(this.mDisplayMetrics, this.mMaxLengthSeconds, this.mSpeedUpFactor, this.mX2, this.mY2);
            return flingAnimationUtils;
        }
    }
    ...
    private AnimatorProperties getDismissingProperties(float f, float f2, float f3, float f4) {
        ...
        float f6 = calculateLinearOutFasterInY2 / 0.5f;
