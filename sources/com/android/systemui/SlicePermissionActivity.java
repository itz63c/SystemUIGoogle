...
public class SlicePermissionActivity extends Activity implements OnClickListener, OnDismissListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        try {
            ...
            AlertDialog create = new Builder(this).setTitle(getString(C2017R$string.slice_permission_title, new Object[]{unicodeWrap, unicodeWrap2})).setView(C2013R$layout.slice_permission_request).setNegativeButton(C2017R$string.slice_permission_deny, this).setPositiveButton(C2017R$string.slice_permission_allow, this).setOnDismissListener(this).create();
            create.getWindow().addSystemFlags(524288);
            create.show();
            ((TextView) create.getWindow().getDecorView().findViewById(C2011R$id.text1)).setText(getString(C2017R$string.slice_permission_text_1, new Object[]{unicodeWrap2}));
            ((TextView) create.getWindow().getDecorView().findViewById(C2011R$id.text2)).setText(getString(C2017R$string.slice_permission_text_2, new Object[]{unicodeWrap2}));
            CheckBox checkBox = (CheckBox) create.getWindow().getDecorView().findViewById(C2011R$id.slice_permission_checkbox);
            this.mAllCheckbox = checkBox;
            checkBox.setText(getString(C2017R$string.slice_permission_checkbox, new Object[]{unicodeWrap}));
