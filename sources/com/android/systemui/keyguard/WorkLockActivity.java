...
public class WorkLockActivity extends Activity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        view.setContentDescription(getString(C2017R$string.accessibility_desc_work_lock));
    ...
    private void showConfirmCredentialActivity() {
        if (!isFinishing() && getKeyguardManager().isDeviceLocked(getTargetUserId())) {
            Intent createConfirmDeviceCredentialIntent = getKeyguardManager().createConfirmDeviceCredentialIntent(null, null, getTargetUserId(), true);
    ...
    public final int getPrimaryColor() {
        TaskDescription taskDescription = (TaskDescription) getIntent().getExtra("com.android.systemui.keyguard.extra.TASK_DESCRIPTION");
