...
public final class StructureAdapter extends Adapter<StructureHolder> {
    ...
    public static final class StructureHolder extends ViewHolder {
        ...
        public StructureHolder(View view) {
            ...
            super(view);
            View requireViewById = this.itemView.requireViewById(C2011R$id.listAll);
            ...
            this.controlAdapter = new ControlAdapter(context.getResources().getFloat(C2009R$dimen.control_card_elevation));
            setUpRecyclerView();
        }
        ...
        private final void setUpRecyclerView() {
            ...
            Intrinsics.checkExpressionValueIsNotNull(context, "itemView.context");
            int dimensionPixelSize = context.getResources().getDimensionPixelSize(C2009R$dimen.controls_card_margin);
    ...
    public StructureHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        View inflate = LayoutInflater.from(viewGroup.getContext()).inflate(C2013R$layout.controls_structure_page, viewGroup, false);
    ...
    public void onBindViewHolder(StructureHolder structureHolder, int i) {
        ...
        structureHolder.bind(((StructureContainer) this.models.get(i)).getModel());
    }
}
