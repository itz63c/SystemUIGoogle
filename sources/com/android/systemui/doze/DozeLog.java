...
public class DozeLog implements Dumpable {
    ...
    public void tracePulseDropped(boolean z, State state, boolean z2) {
    ...
    public void traceDozeSuppressed(State state) {
