...
public class DozeFalsingManagerAdapter implements Part {
    ...
    static /* synthetic */ class C08231 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.systemui.doze.DozeFalsingManagerAdapter.C08231.<clinit>():void");
        }
    }
    ...
    private boolean isAodMode(State state) {
        int i = C08231.$SwitchMap$com$android$systemui$doze$DozeMachine$State[state.ordinal()];
        return i == 1 || i == 2 || i == 3;
    }
}
