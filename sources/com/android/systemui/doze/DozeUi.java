...
public class DozeUi implements Part {
    ...
    static /* synthetic */ class C08333 {
        ...
        static {
            ...
            L_0x0084:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.systemui.doze.DozeUi.C08333.<clinit>():void");
        }
    }
    ...
    public void transitionTo(State state, State state2) {
        switch (C08333.$SwitchMap$com$android$systemui$doze$DozeMachine$State[state2.ordinal()]) {
            case 1:
            case 2:
    ...
    private void updateAnimateWakeup(State state) {
        boolean z = true;
        switch (C08333.$SwitchMap$com$android$systemui$doze$DozeMachine$State[state.ordinal()]) {
            case 6:
            case 9:
            case 10:
            case 11:
