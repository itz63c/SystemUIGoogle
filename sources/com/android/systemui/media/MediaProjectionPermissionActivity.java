...
public class MediaProjectionPermissionActivity extends Activity implements OnClickListener, OnCancelListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        String str;
        String str2 = "MediaProjectionPermissionActivity";
        ...
        try {
            ...
            try {
                ...
                if (Utils.isHeadlessRemoteDisplayProvider(packageManager, this.mPackageName)) {
                    CharSequence string = getString(C2017R$string.media_projection_dialog_service_text);
                    str = getString(C2017R$string.media_projection_dialog_service_title);
                    charSequence = string;
                } else {
                    ...
                    while (true) {
                        ...
                        if (type == 13 || type == 15 || type == 14) {
                            ...
                            sb.append(charSequence2.substring(0, i2));
                            sb.append("…");
                    ...
                    String string2 = getString(C2017R$string.media_projection_dialog_text, new Object[]{unicodeWrap});
                    ...
                    str = getString(C2017R$string.media_projection_dialog_title, new Object[]{unicodeWrap});
                    charSequence = spannableString;
                }
                View inflate = View.inflate(this, C2013R$layout.media_projection_dialog_title, null);
                ((TextView) inflate.findViewById(C2011R$id.dialog_title)).setText(str);
                AlertDialog create = new Builder(this).setCustomTitle(inflate).setMessage(charSequence).setPositiveButton(C2017R$string.media_projection_action_text, this).setNegativeButton(17039360, this).setOnCancelListener(this).create();
                this.mDialog = create;
                create.create();
                ...
                Log.e(str2, "Error checking projection permissions", e);
                finish();
            }
        } catch (NameNotFoundException e2) {
            Log.e(str2, "unable to look up package name", e2);
            finish();
        }
    }
