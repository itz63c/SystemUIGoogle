...
public class NavBarTuner extends TunerPreferenceFragment {
    private static final int[][] ICONS = {new int[]{C2010R$drawable.ic_qs_circle, C2017R$string.tuner_circle}, new int[]{C2010R$drawable.ic_add, C2017R$string.tuner_plus}, new int[]{C2010R$drawable.ic_remove, C2017R$string.tuner_minus}, new int[]{C2010R$drawable.ic_left, C2017R$string.tuner_left}, new int[]{C2010R$drawable.ic_right, C2017R$string.tuner_right}, new int[]{C2010R$drawable.ic_menu, C2017R$string.tuner_menu}};
    ...
    public void onCreatePreferences(Bundle bundle, String str) {
        addPreferencesFromResource(C2019R$xml.nav_bar_tuner);
