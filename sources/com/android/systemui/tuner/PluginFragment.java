...
public class PluginFragment extends PreferenceFragment {
    ...
    private static class PluginPreference extends SwitchPreference {
        ...
        public PluginPreference(Context context, PackageInfo packageInfo, PluginEnabler pluginEnabler) {
            ...
            setWidgetLayoutResource(C2013R$layout.tuner_widget_settings_switch);
        }
        ...
        public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
            ...
            int i = 0;
            preferenceViewHolder.findViewById(C2011R$id.settings).setVisibility(this.mHasSettings ? 0 : 8);
            View findViewById = preferenceViewHolder.findViewById(C2011R$id.divider);
            if (!this.mHasSettings) {
                i = 8;
            }
            findViewById.setVisibility(i);
            preferenceViewHolder.findViewById(C2011R$id.settings).setOnClickListener(new OnClickListener() {
                public final void onClick(View view) {
                    PluginPreference.this.lambda$onBindViewHolder$0$PluginFragment$PluginPreference(view);
                }
            });
            preferenceViewHolder.itemView.setOnLongClickListener(new OnLongClickListener() {
                public final boolean onLongClick(View view) {
                    return PluginPreference.this.lambda$onBindViewHolder$1$PluginFragment$PluginPreference(view);
                }
            });
        }
    ...
    public void loadPrefs() {
        ...
        List packagesHoldingPermissions = packageManager.getPackagesHoldingPermissions(new String[]{"com.android.systemui.permission.PLUGIN"}, 516);
        $$Lambda$PluginFragment$iW8kXrJfaof7fDZHqMxR_RNftYk r1 = new Consumer(arrayMap, pluginManager, context, createPreferenceScreen) {
        ...
        packagesHoldingPermissions.forEach(r1);
    ...
    public /* synthetic */ void lambda$loadPrefs$0$PluginFragment(ArrayMap arrayMap, PluginManager pluginManager, Context context, PreferenceScreen preferenceScreen, PackageInfo packageInfo) {
        if (arrayMap.containsKey(packageInfo.packageName) && !ArrayUtils.contains(pluginManager.getWhitelistedPlugins(), packageInfo.packageName)) {
            ...
            sb.append("Plugins: ");
            sb.append(toString((ArraySet) arrayMap.get(packageInfo.packageName)));
            pluginPreference.setSummary((CharSequence) sb.toString());
