...
public class TunerActivity extends Activity implements OnPreferenceStartFragmentCallback, OnPreferenceStartScreenCallback {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(C2013R$layout.tuner_activity);
        Toolbar toolbar = (Toolbar) findViewById(C2011R$id.action_bar);
        if (toolbar != null) {
        ...
        if (getFragmentManager().findFragmentByTag(str) == null) {
            ...
            getFragmentManager().beginTransaction().replace(C2011R$id.content_frame, fragment, str).commit();
        }
    }
    ...
    public boolean onPreferenceStartFragment(PreferenceFragment preferenceFragment, Preference preference) {
        try {
            ...
            beginTransaction.replace(C2011R$id.content_frame, fragment);
    ...
    public boolean onPreferenceStartScreen(PreferenceFragment preferenceFragment, PreferenceScreen preferenceScreen) {
        ...
        beginTransaction.replace(C2011R$id.content_frame, subSettingsFragment);
        beginTransaction.addToBackStack("PreferenceFragment");
        beginTransaction.commit();
        return true;
    }
