...
import com.android.systemui.tuner.CustomListPreference.CustomListPreferenceDialogFragment;
...
public abstract class TunerPreferenceFragment extends PreferenceFragment {
    public void onDisplayPreferenceDialog(Preference preference) {
        ...
        if (preference instanceof CustomListPreference) {
            listPreferenceDialogFragment = CustomListPreferenceDialogFragment.newInstance(preference.getKey());
        } else {
