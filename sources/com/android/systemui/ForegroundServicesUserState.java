...
public class ForegroundServicesUserState {
    ...
    public void addOp(String str, int i) {
        ...
        ((ArraySet) this.mAppOps.get(str)).add(Integer.valueOf(i));
    }

    public boolean removeOp(String str, int i) {
        ArraySet arraySet = (ArraySet) this.mAppOps.get(str);
        if (arraySet == null) {
            return false;
        }
    ...
    public void addNotification(ArrayMap<String, ArraySet<String>> arrayMap, String str, String str2) {
        ...
        ((ArraySet) arrayMap.get(str)).add(str2);
    }
    ...
    public boolean isDisclosureNeeded() {
        if (this.mRunning != null && System.currentTimeMillis() - this.mServiceStartTime >= 5000) {
            for (String str : this.mRunning) {
                ArraySet arraySet = (ArraySet) this.mImportantNotifications.get(str);
    ...
    public ArraySet<Integer> getFeatures(String str) {
        return (ArraySet) this.mAppOps.get(str);
    }

    public String getStandardLayoutKey(String str) {
        ArraySet arraySet = (ArraySet) this.mStandardLayoutNotifications.get(str);
        if (arraySet == null || arraySet.size() == 0) {
            return null;
        }
        return (String) arraySet.valueAt(0);
    }
