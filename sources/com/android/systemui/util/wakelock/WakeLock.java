...
public interface WakeLock {
    ...
    static WakeLock wrap(final android.os.PowerManager.WakeLock wakeLock, final long j) {
        return new WakeLock() {
            private final HashMap<String, Integer> mActiveClients = new HashMap<>();

            public void acquire(String str) {
                this.mActiveClients.putIfAbsent(str, Integer.valueOf(0));
            ...
            public void release(String str) {
                Integer num = (Integer) this.mActiveClients.get(str);
                if (num == null) {
