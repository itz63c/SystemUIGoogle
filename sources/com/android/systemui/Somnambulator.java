...
public class Somnambulator extends Activity {
    public void onStart() {
        ...
        if ("android.intent.action.CREATE_SHORTCUT".equals(intent.getAction())) {
            ...
            intent3.putExtra("android.intent.extra.shortcut.ICON_RESOURCE", ShortcutIconResource.fromContext(this, C2014R$mipmap.ic_launcher_dreams));
            intent3.putExtra("android.intent.extra.shortcut.INTENT", intent2);
            intent3.putExtra("android.intent.extra.shortcut.NAME", getString(C2017R$string.start_dreams));
            setResult(-1, intent3);
