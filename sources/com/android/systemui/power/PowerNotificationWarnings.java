...
public class PowerNotificationWarnings implements WarningsUI {
    ...
    static {
        new Builder().setContentType(4).setUsage(13).build();
    }
    ...
    private void showInvalidChargerNotification() {
        Notification.Builder color = new Notification.Builder(this.mContext, NotificationChannels.ALERTS).setSmallIcon(C2010R$drawable.ic_power_low).setWhen(0).setShowWhen(false).setOngoing(true).setContentTitle(this.mContext.getString(C2017R$string.invalid_charger_title)).setContentText(this.mContext.getString(C2017R$string.invalid_charger_text)).setColor(this.mContext.getColor(17170460));
    ...
    public void showWarningNotification() {
        ...
        String string = this.mContext.getString(C2017R$string.battery_low_title);
        if (this.mCurrentBatterySnapshot.isHybrid()) {
            str = getHybridContentString(format);
        } else {
            str = this.mContext.getString(C2017R$string.battery_low_percent_format, new Object[]{format});
        }
        Notification.Builder visibility = new Notification.Builder(this.mContext, NotificationChannels.BATTERY).setSmallIcon(C2010R$drawable.ic_power_low).setWhen(this.mWarningTriggerTimeMs).setShowWhen(false).setContentText(str).setContentTitle(string).setOnlyAlertOnce(true).setDeleteIntent(pendingBroadcast("PNW.dismissedWarning")).setStyle(new BigTextStyle().bigText(str)).setVisibility(1);
        ...
        if (!this.mPowerMan.isPowerSaveMode()) {
            visibility.addAction(0, this.mContext.getString(C2017R$string.battery_saver_start_action), pendingBroadcast("PNW.startSaver"));
        }
    ...
    private void showAutoSaverSuggestionNotification() {
        Notification.Builder contentText = new Notification.Builder(this.mContext, NotificationChannels.HINTS).setSmallIcon(C2010R$drawable.ic_power_saver).setWhen(0).setShowWhen(false).setContentTitle(this.mContext.getString(C2017R$string.auto_saver_title)).setContentText(this.mContext.getString(C2017R$string.auto_saver_text));
        ...
        contentText.addAction(0, this.mContext.getString(C2017R$string.no_auto_saver_action), pendingBroadcast("PNW.autoSaverNoThanks"));
    ...
    public void showHighTemperatureWarning() {
        if (!this.mHighTempWarning) {
            ...
            Notification.Builder color = new Notification.Builder(this.mContext, NotificationChannels.ALERTS).setSmallIcon(C2010R$drawable.ic_device_thermostat_24).setWhen(0).setShowWhen(false).setContentTitle(this.mContext.getString(C2017R$string.high_temp_title)).setContentText(this.mContext.getString(C2017R$string.high_temp_notif_message)).setVisibility(1).setContentIntent(pendingBroadcast("PNW.clickedTempWarning")).setDeleteIntent(pendingBroadcast("PNW.dismissedTempWarning")).setColor(Utils.getColorAttrDefaultColor(this.mContext, 16844099));
            SystemUI.overrideNotificationAppName(this.mContext, color, false);
    ...
    public void showHighTemperatureDialog() {
        if (this.mHighTempDialog == null) {
            ...
            systemUIDialog.setTitle(C2017R$string.high_temp_title);
            systemUIDialog.setMessage(C2017R$string.high_temp_dialog_message);
    ...
    public void showThermalShutdownDialog() {
        if (this.mThermalShutdownDialog == null) {
            SystemUIDialog systemUIDialog = new SystemUIDialog(this.mContext);
            systemUIDialog.setIconAttribute(16843605);
            systemUIDialog.setTitle(C2017R$string.thermal_shutdown_title);
            systemUIDialog.setMessage(C2017R$string.thermal_shutdown_dialog_message);
            systemUIDialog.setPositiveButton(17039370, null);
            systemUIDialog.setShowForAllUsers(true);
            systemUIDialog.setOnDismissListener(new OnDismissListener() {
                public final void onDismiss(DialogInterface dialogInterface) {
    ...
    public void lambda$showUsbHighTemperatureAlarm$2() {
        if (this.mUsbHighTempDialog == null) {
            SystemUIDialog systemUIDialog = new SystemUIDialog(this.mContext, C2018R$style.Theme_SystemUI_Dialog_Alert);
            systemUIDialog.setCancelable(false);
            systemUIDialog.setIconAttribute(16843605);
            systemUIDialog.setTitle(C2017R$string.high_temp_alarm_title);
            systemUIDialog.setShowForAllUsers(true);
            systemUIDialog.setMessage(this.mContext.getString(C2017R$string.high_temp_alarm_notify_message, new Object[]{""}));
            systemUIDialog.setPositiveButton(17039370, new OnClickListener() {
                public final void onClick(DialogInterface dialogInterface, int i) {
                    PowerNotificationWarnings.this.mo12673xcabad378(dialogInterface, i);
                }
            });
            systemUIDialog.setNegativeButton(C2017R$string.high_temp_alarm_help_care_steps, new OnClickListener() {
                public final void onClick(DialogInterface dialogInterface, int i) {
                    PowerNotificationWarnings.this.mo12675x3d5cf4fa(dialogInterface, i);
                }
            });
            systemUIDialog.setOnDismissListener(new OnDismissListener() {
                public final void onDismiss(DialogInterface dialogInterface) {
                    PowerNotificationWarnings.this.mo12676x76ae05bb(dialogInterface);
                }
            });
            systemUIDialog.getWindow().addFlags(2097280);
            systemUIDialog.show();
            this.mUsbHighTempDialog = systemUIDialog;
            Events.writeEvent(19, Integer.valueOf(3), Boolean.valueOf(this.mKeyguard.isKeyguardLocked()));
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: lambda$showUsbHighTemperatureAlarmInternal$3 */
    public /* synthetic */ void mo12673xcabad378(DialogInterface dialogInterface, int i) {
        this.mUsbHighTempDialog = null;
    }

    /* access modifiers changed from: private */
    /* renamed from: lambda$showUsbHighTemperatureAlarmInternal$5 */
    public /* synthetic */ void mo12675x3d5cf4fa(DialogInterface dialogInterface, int i) {
        String string = this.mContext.getString(C2017R$string.high_temp_alarm_help_url);
        ...
        ((ActivityStarter) Dependency.get(ActivityStarter.class)).startActivity(intent, true, (Callback) new Callback() {
            public final void onActivityStarted(int i) {
                PowerNotificationWarnings.this.mo12674x40be439(i);
            }
        });
    }
    ...
    public /* synthetic */ void mo12674x40be439(int i) {
        this.mUsbHighTempDialog = null;
    }

    /* access modifiers changed from: private */
    /* renamed from: lambda$showUsbHighTemperatureAlarmInternal$6 */
    public /* synthetic */ void mo12676x76ae05bb(DialogInterface dialogInterface) {
        this.mUsbHighTempDialog = null;
        Events.writeEvent(20, Integer.valueOf(9), Boolean.valueOf(this.mKeyguard.isKeyguardLocked()));
    }
    ...
    public void showStartSaverConfirmation(Bundle bundle) {
        if (this.mSaverConfirmation == null) {
            ...
            if (z) {
                systemUIDialog.setTitle(C2017R$string.battery_saver_confirmation_title_generic);
                systemUIDialog.setPositiveButton(17039868, new OnClickListener(i, i2) {
                ...
                systemUIDialog.setTitle(C2017R$string.battery_saver_confirmation_title);
                systemUIDialog.setPositiveButton(C2017R$string.battery_saver_confirmation_ok, new OnClickListener() {
                    public final void onClick(DialogInterface dialogInterface, int i) {
    ...
    public /* synthetic */ void lambda$showStartSaverConfirmation$7$PowerNotificationWarnings(int i, int i2, DialogInterface dialogInterface, int i3) {
        ...
        Secure.putIntForUser(contentResolver, "low_power_warning_acknowledged", 1, -2);
    }
    ...
    private CharSequence getBatterySaverDescription() {
        ...
        String charSequence = this.mContext.getText(C2017R$string.help_uri_battery_saver_learn_more_link_target).toString();
        if (TextUtils.isEmpty(charSequence)) {
            return this.mContext.getText(17039646);
        }
        SpannableString spannableString = new SpannableString(this.mContext.getText(17039647));
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(spannableString);
        for (Annotation annotation : (Annotation[]) spannableString.getSpans(0, spannableString.length(), Annotation.class)) {
            if ("url".equals(annotation.getValue())) {
                int spanStart = spannableString.getSpanStart(annotation);
                int spanEnd = spannableString.getSpanEnd(annotation);
                C09431 r8 = new URLSpan(charSequence) {
