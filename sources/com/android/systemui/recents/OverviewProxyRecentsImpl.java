...
public class OverviewProxyRecentsImpl implements RecentsImplementation {
    ...
    private TaskStackChangeListener mListener = new TaskStackChangeListener() {
        public void onActivityRestartAttempt(RunningTaskInfo runningTaskInfo, boolean z, boolean z2) {
            if (runningTaskInfo.configuration.windowConfiguration.getWindowingMode() == 3 && z) {
    ...
    public OverviewProxyRecentsImpl(Optional<Lazy<StatusBar>> optional, Optional<Divider> optional2) {
        this.mStatusBarLazy = (Lazy) optional.orElse(null);
    ...
    public void toggleRecentApps() {
        if (this.mOverviewProxyService.getProxy() != null) {
            ...
            if (lazy == null || !((StatusBar) lazy.get()).isKeyguardShowing()) {
                r0.run();
            } else {
                ((StatusBar) this.mStatusBarLazy.get()).executeRunnableDismissingKeyguard(new Runnable(r0) {
