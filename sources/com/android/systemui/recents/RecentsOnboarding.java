...
public class RecentsOnboarding {
    ...
    private final OnAttachStateChangeListener mOnAttachStateChangeListener = new OnAttachStateChangeListener() {
        ...
        public void onViewAttachedToWindow(View view) {
            if (view == RecentsOnboarding.this.mLayout) {
                ...
                if (view.getTag().equals(Integer.valueOf(C2017R$string.recents_swipe_up_onboarding))) {
        ...
        public void onViewDetachedFromWindow(View view) {
            if (view == RecentsOnboarding.this.mLayout) {
                ...
                if (view.getTag().equals(Integer.valueOf(C2017R$string.recents_quick_scrub_onboarding))) {
                    ...
                    if (runningTask.configuration.windowConfiguration.getActivityType() == 1) {
                        ...
                        if (access$100 && access$200) {
                                ...
                                if (RecentsOnboarding.this.mHasDismissedSwipeUpTip) {
                                    ...
                                    if (access$500 <= 2) {
                                        ...
                                        if (RecentsOnboarding.this.mNumAppsLaunchedSinceSwipeUpTipDismiss >= i) {
                                            ...
                                            z2 = RecentsOnboarding.this.show(C2017R$string.recents_swipe_up_onboarding);
                                        } else {
                                            z2 = false;
                                        }
                                    } else {
                            ...
                            if (!RecentsOnboarding.this.mHasDismissedQuickScrubTip) {
                                z = RecentsOnboarding.this.show(C2017R$string.recents_quick_scrub_onboarding);
    ...
    public RecentsOnboarding(Context context, OverviewProxyService overviewProxyService) {
        ...
        Collections.addAll(hashSet, resources.getStringArray(C2005R$array.recents_onboarding_blacklisted_packages));
        View inflate = LayoutInflater.from(this.mContext).inflate(C2013R$layout.recents_onboarding, null);
        this.mLayout = inflate;
        this.mTextView = (TextView) inflate.findViewById(C2011R$id.onboarding_text);
        this.mDismissView = (ImageView) this.mLayout.findViewById(C2011R$id.dismiss);
        this.mArrowView = this.mLayout.findViewById(C2011R$id.arrow);
        ...
        this.mOnboardingToastArrowRadius = resources.getDimensionPixelSize(C2009R$dimen.recents_onboarding_toast_arrow_corner_radius);
    ...
    public boolean show(int i) {
        ...
        if (i == C2017R$string.recents_swipe_up_onboarding) {
            i2 = 81;
        } else {
            i2 = (this.mContext.getResources().getConfiguration().getLayoutDirection() == 0 ? 3 : 5) | 80;
            i3 = this.mContext.getResources().getDimensionPixelSize(C2009R$dimen.recents_quick_scrub_onboarding_margin_start);
        }
