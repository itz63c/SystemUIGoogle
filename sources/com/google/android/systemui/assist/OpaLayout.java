...
public class OpaLayout extends FrameLayout implements ButtonInterface, FeedbackEffect {
    ...
    public void onFinishInflate() {
        ...
        this.mWhite = (ImageView) findViewById(C2011R$id.white);
        this.mWhiteCutout = (ImageView) findViewById(C2011R$id.white_cutout);
        this.mHalo = (ImageView) findViewById(C2011R$id.halo);
        this.mHome = (KeyButtonView) findViewById(C2011R$id.home_button);
        this.mHalo.setImageDrawable(KeyButtonDrawable.create(new ContextThemeWrapper(getContext(), C2018R$style.DualToneLightTheme), new ContextThemeWrapper(getContext(), C2018R$style.DualToneDarkTheme), C2010R$drawable.halo, true, null));
        this.mHomeDiameter = this.mResources.getDimensionPixelSize(C2009R$dimen.opa_disabled_home_diameter);
    ...
    public void setOnLongClickListener(OnLongClickListener onLongClickListener) {
        this.mHome.setOnLongClickListener(new OnLongClickListener(onLongClickListener) {
            public final /* synthetic */ OnLongClickListener f$1;
    ...
    /* access modifiers changed from: private */
    /* renamed from: lambda$setOnLongClickListener$0 */
    public /* synthetic */ boolean lambda$setOnLongClickListener$0$OpaLayout(OnLongClickListener onLongClickListener, View view) {
    ...
    private ArraySet<Animator> getDiamondAnimatorSet() {
        ...
        arraySet.add(OpaUtils.getDeltaAnimatorY(this.mTop, this.mDiamondInterpolator, -OpaUtils.getPxVal(this.mResources, C2009R$dimen.opa_diamond_translation), 200));
        ...
        arraySet.add(OpaUtils.getDeltaAnimatorY(this.mBottom, this.mDiamondInterpolator, OpaUtils.getPxVal(this.mResources, C2009R$dimen.opa_diamond_translation), 200));
        ...
        arraySet.add(OpaUtils.getDeltaAnimatorX(this.mLeft, this.mDiamondInterpolator, -OpaUtils.getPxVal(this.mResources, C2009R$dimen.opa_diamond_translation), 200));
        ...
        arraySet.add(OpaUtils.getDeltaAnimatorX(this.mRight, this.mDiamondInterpolator, OpaUtils.getPxVal(this.mResources, C2009R$dimen.opa_diamond_translation), 200));
    ...
    private ArraySet<Animator> getLineAnimatorSet() {
        ArraySet<Animator> arraySet = new ArraySet<>();
        if (this.mIsVertical) {
            arraySet.add(OpaUtils.getDeltaAnimatorY(this.mRed, Interpolators.FAST_OUT_SLOW_IN, OpaUtils.getPxVal(this.mResources, C2009R$dimen.opa_line_x_trans_ry), 225));
            arraySet.add(OpaUtils.getDeltaAnimatorX(this.mRed, Interpolators.FAST_OUT_SLOW_IN, OpaUtils.getPxVal(this.mResources, C2009R$dimen.opa_line_y_translation), 133));
            arraySet.add(OpaUtils.getDeltaAnimatorY(this.mBlue, Interpolators.FAST_OUT_SLOW_IN, OpaUtils.getPxVal(this.mResources, C2009R$dimen.opa_line_x_trans_bg), 225));
            arraySet.add(OpaUtils.getDeltaAnimatorY(this.mYellow, Interpolators.FAST_OUT_SLOW_IN, -OpaUtils.getPxVal(this.mResources, C2009R$dimen.opa_line_x_trans_ry), 225));
            arraySet.add(OpaUtils.getDeltaAnimatorX(this.mYellow, Interpolators.FAST_OUT_SLOW_IN, -OpaUtils.getPxVal(this.mResources, C2009R$dimen.opa_line_y_translation), 133));
            arraySet.add(OpaUtils.getDeltaAnimatorY(this.mGreen, Interpolators.FAST_OUT_SLOW_IN, -OpaUtils.getPxVal(this.mResources, C2009R$dimen.opa_line_x_trans_bg), 225));
        } else {
            arraySet.add(OpaUtils.getDeltaAnimatorX(this.mRed, Interpolators.FAST_OUT_SLOW_IN, -OpaUtils.getPxVal(this.mResources, C2009R$dimen.opa_line_x_trans_ry), 225));
            arraySet.add(OpaUtils.getDeltaAnimatorY(this.mRed, Interpolators.FAST_OUT_SLOW_IN, OpaUtils.getPxVal(this.mResources, C2009R$dimen.opa_line_y_translation), 133));
            arraySet.add(OpaUtils.getDeltaAnimatorX(this.mBlue, Interpolators.FAST_OUT_SLOW_IN, -OpaUtils.getPxVal(this.mResources, C2009R$dimen.opa_line_x_trans_bg), 225));
            arraySet.add(OpaUtils.getDeltaAnimatorX(this.mYellow, Interpolators.FAST_OUT_SLOW_IN, OpaUtils.getPxVal(this.mResources, C2009R$dimen.opa_line_x_trans_ry), 225));
            arraySet.add(OpaUtils.getDeltaAnimatorY(this.mYellow, Interpolators.FAST_OUT_SLOW_IN, -OpaUtils.getPxVal(this.mResources, C2009R$dimen.opa_line_y_translation), 133));
            arraySet.add(OpaUtils.getDeltaAnimatorX(this.mGreen, Interpolators.FAST_OUT_SLOW_IN, OpaUtils.getPxVal(this.mResources, C2009R$dimen.opa_line_x_trans_bg), 225));
        }
    ...
    public void updateOpaLayout() {
        ...
        LayoutParams layoutParams = (LayoutParams) this.mHalo.getLayoutParams();
        ...
        ScaleType scaleType = z ? ScaleType.FIT_CENTER : ScaleType.CENTER;
    ...
    private AnimatorSet getGestureAnimatorSet() {
        ...
        if (this.mIsVertical) {
            ObjectAnimator translationObjectAnimatorY = OpaUtils.getTranslationObjectAnimatorY(this.mRed, OpaUtils.INTERPOLATOR_40_40, OpaUtils.getPxVal(this.mResources, C2009R$dimen.opa_line_x_trans_ry), this.mRed.getY() + OpaUtils.getDeltaDiamondPositionLeftY(), 350);
            translationObjectAnimatorY.addListener(new AnimatorListenerAdapter() {
                public void onAnimationEnd(Animator animator) {
                    OpaLayout.this.startCollapseAnimation();
                }
            });
            this.mGestureLineSet.play(translationObjectAnimatorY).with(scaleObjectAnimator3).with(OpaUtils.getTranslationObjectAnimatorY(this.mBlue, OpaUtils.INTERPOLATOR_40_40, OpaUtils.getPxVal(this.mResources, C2009R$dimen.opa_line_x_trans_bg), this.mBlue.getY() + OpaUtils.getDeltaDiamondPositionBottomY(this.mResources), 350)).with(OpaUtils.getTranslationObjectAnimatorY(this.mYellow, OpaUtils.INTERPOLATOR_40_40, -OpaUtils.getPxVal(this.mResources, C2009R$dimen.opa_line_x_trans_ry), this.mYellow.getY() + OpaUtils.getDeltaDiamondPositionRightY(), 350)).with(OpaUtils.getTranslationObjectAnimatorY(this.mGreen, OpaUtils.INTERPOLATOR_40_40, -OpaUtils.getPxVal(this.mResources, C2009R$dimen.opa_line_x_trans_bg), this.mGreen.getY() + OpaUtils.getDeltaDiamondPositionTopY(this.mResources), 350));
        } else {
            ObjectAnimator translationObjectAnimatorX = OpaUtils.getTranslationObjectAnimatorX(this.mRed, OpaUtils.INTERPOLATOR_40_40, -OpaUtils.getPxVal(this.mResources, C2009R$dimen.opa_line_x_trans_ry), this.mRed.getX() + OpaUtils.getDeltaDiamondPositionTopX(), 350);
            translationObjectAnimatorX.addListener(new AnimatorListenerAdapter() {
                public void onAnimationEnd(Animator animator) {
                    OpaLayout.this.startCollapseAnimation();
                }
            });
            this.mGestureLineSet.play(translationObjectAnimatorX).with(scaleObjectAnimator).with(OpaUtils.getTranslationObjectAnimatorX(this.mBlue, OpaUtils.INTERPOLATOR_40_40, -OpaUtils.getPxVal(this.mResources, C2009R$dimen.opa_line_x_trans_bg), this.mBlue.getX() + OpaUtils.getDeltaDiamondPositionLeftX(this.mResources), 350)).with(OpaUtils.getTranslationObjectAnimatorX(this.mYellow, OpaUtils.INTERPOLATOR_40_40, OpaUtils.getPxVal(this.mResources, C2009R$dimen.opa_line_x_trans_ry), this.mYellow.getX() + OpaUtils.getDeltaDiamondPositionBottomX(), 350)).with(OpaUtils.getTranslationObjectAnimatorX(this.mGreen, OpaUtils.INTERPOLATOR_40_40, OpaUtils.getPxVal(this.mResources, C2009R$dimen.opa_line_x_trans_bg), this.mGreen.getX() + OpaUtils.getDeltaDiamondPositionRightX(this.mResources), 350));
        }
        return this.mGestureLineSet;
    }
}
