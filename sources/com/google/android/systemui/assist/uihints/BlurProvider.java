...
public final class BlurProvider {
    ...
    private static class BlurKernel {
        ...
        private Allocation createAllocationForBitmap(Bitmap bitmap) {
            return Allocation.createFromBitmap(this.mBlurRenderScript, bitmap, MipmapControl.MIPMAP_NONE, 1);
        }
    ...
    public class BlurResult {
        ...
        BlurResult(BlurProvider blurProvider, Drawable drawable2, RectF rectF) {
            this.drawable = drawable2;
            this.cropRegion = rectF;
        }

        BlurResult(BlurProvider blurProvider, Drawable drawable2) {
            this(blurProvider, drawable2, new RectF(0.0f, 0.0f, (float) drawable2.getIntrinsicWidth(), (float) drawable2.getIntrinsicHeight()));
        }
    }
    ...
    private static class SourceDownsampler {
        ...
        public Bitmap createBitmapBuffer(int i) {
            return Bitmap.createBitmap(getDownsampledWidth(i), getDownsampledHeight(i), Config.ARGB_8888);
        }
    ...
    private BlurResult blur(float f, Bitmap bitmap, Bitmap bitmap2) {
        ...
        return new BlurResult(this, new BitmapDrawable(this.mResources, bitmap2), getBitmapVisibleRegion(bitmap2, this.mImageSource.getDownsampledWidth(numDownsampleStepsForEffectiveRadius), this.mImageSource.getDownsampledHeight(numDownsampleStepsForEffectiveRadius)));
    }
