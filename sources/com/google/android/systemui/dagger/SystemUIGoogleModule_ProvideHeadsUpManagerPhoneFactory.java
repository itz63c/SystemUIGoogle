...
public final class SystemUIGoogleModule_ProvideHeadsUpManagerPhoneFactory implements Factory<HeadsUpManagerPhone> {
    ...
    public SystemUIGoogleModule_ProvideHeadsUpManagerPhoneFactory(Provider<Context> provider, Provider<StatusBarStateController> provider2, Provider<KeyguardBypassController> provider3, Provider<NotificationGroupManager> provider4, Provider<ConfigurationController> provider5) {
    ...
    public static SystemUIGoogleModule_ProvideHeadsUpManagerPhoneFactory create(Provider<Context> provider, Provider<StatusBarStateController> provider2, Provider<KeyguardBypassController> provider3, Provider<NotificationGroupManager> provider4, Provider<ConfigurationController> provider5) {
        SystemUIGoogleModule_ProvideHeadsUpManagerPhoneFactory systemUIGoogleModule_ProvideHeadsUpManagerPhoneFactory = new SystemUIGoogleModule_ProvideHeadsUpManagerPhoneFactory(provider, provider2, provider3, provider4, provider5);
        return systemUIGoogleModule_ProvideHeadsUpManagerPhoneFactory;
    }
    ...
    public static HeadsUpManagerPhone proxyProvideHeadsUpManagerPhone(Context context, StatusBarStateController statusBarStateController, KeyguardBypassController keyguardBypassController, NotificationGroupManager notificationGroupManager, ConfigurationController configurationController) {
        HeadsUpManagerPhone provideHeadsUpManagerPhone = SystemUIGoogleModule.provideHeadsUpManagerPhone(context, statusBarStateController, keyguardBypassController, notificationGroupManager, configurationController);
