...
abstract class AbstractIterator<T> implements Iterator<T> {
    ...
    static /* synthetic */ class C19511 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.base.AbstractIterator.C19511.<clinit>():void");
        }
    }
    ...
    public final boolean hasNext() {
        ...
        int i = C19511.$SwitchMap$com$google$common$base$AbstractIterator$State[this.state.ordinal()];
        if (i == 1) {
            return true;
        }
        if (i != 2) {
