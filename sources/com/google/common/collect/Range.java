...
public final class Range<C extends Comparable> extends RangeGwtSerializationDependencies implements Object<C> {
    ...
    static /* synthetic */ class C19831 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.collect.Range.C19831.<clinit>():void");
        }
    }
    ...
    public static <C extends Comparable<?>> Range<C> upTo(C c, BoundType boundType) {
        int i = C19831.$SwitchMap$com$google$common$collect$BoundType[boundType.ordinal()];
        if (i == 1) {
            return lessThan(c);
        }
        if (i == 2) {
