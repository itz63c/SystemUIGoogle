...
public interface IWirelessChargerInfoCallback extends IHwInterface {
    ...
    public static abstract class Stub extends HwBinder implements IWirelessChargerInfoCallback {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(new String[]{"vendor.google.wireless_charger@1.1::IWirelessChargerInfoCallback", "android.hidl.base@1.0::IBase"}));
        }

        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[][]{new byte[]{-95, -73, 125, 36, -45, 43, 115, 27, -95, -68, -4, -57, -72, 69, -99, 83, 65, -13, -50, -82, 38, -52, 66, -58, 40, 85, -74, 113, -76, 16, 117, 112}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}}));
        }
        ...
        public void onTransact(int i, HwParcel hwParcel, HwParcel hwParcel2, int i2) throws RemoteException {
            String str = "android.hidl.base@1.0::IBase";
            switch (i) {
                case 1:
