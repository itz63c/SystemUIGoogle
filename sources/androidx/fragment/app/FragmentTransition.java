...
class FragmentTransition {
    ...
    static final FragmentTransitionImpl PLATFORM_IMPL = (VERSION.SDK_INT >= 21 ? new FragmentTransitionCompat21() : null);
    ...
    private static void configureTransitionsReordered(ViewGroup viewGroup, FragmentContainerTransition fragmentContainerTransition, View view, ArrayMap<String, String> arrayMap, Callback callback) {
        ...
        if (chooseImpl != null) {
            ...
            if (mergeTransitions != null) {
                ...
                fragmentTransitionImpl.scheduleRemoveTargets(mergeTransitions, obj3, configureEnteringExitingViews2, obj, arrayList4, configureSharedElementsReordered, arrayList);
    ...
    private static void configureTransitionsOrdered(ViewGroup viewGroup, FragmentContainerTransition fragmentContainerTransition, View view, ArrayMap<String, String> arrayMap, Callback callback) {
        ...
        if (chooseImpl != null) {
            ...
            ArrayList configureEnteringExitingViews = configureEnteringExitingViews(fragmentTransitionImpl, obj, fragment2, arrayList4, view2);
    ...
    public static void calculateFragments(BackStackRecord backStackRecord, SparseArray<FragmentContainerTransition> sparseArray, boolean z) {
        ...
        for (int i = 0; i < size; i++) {
            addToFirstInLastOut(backStackRecord, (C0172Op) backStackRecord.mOps.get(i), sparseArray, false, z);
        }
    }
    ...
    public static void calculatePopFragments(BackStackRecord backStackRecord, SparseArray<FragmentContainerTransition> sparseArray, boolean z) {
        if (backStackRecord.mManager.getContainer().onHasView()) {
            for (int size = backStackRecord.mOps.size() - 1; size >= 0; size--) {
                addToFirstInLastOut(backStackRecord, (C0172Op) backStackRecord.mOps.get(size), sparseArray, true, z);
            }
        }
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:49:0x006d, code lost:
        if (r0.mPostponedAlpha >= 0.0f) goto L_0x006f;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:55:0x0079, code lost:
        if (r0.mHidden == false) goto L_0x006f;
     */
    ...
    private static void addToFirstInLastOut(androidx.fragment.app.BackStackRecord r8, androidx.fragment.app.FragmentTransaction.C0172Op r9, android.util.SparseArray<androidx.fragment.app.FragmentTransition.FragmentContainerTransition> r10, boolean r11, boolean r12) {
        /*
