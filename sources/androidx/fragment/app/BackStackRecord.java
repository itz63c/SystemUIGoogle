...
final class BackStackRecord extends FragmentTransaction implements BackStackEntry, OpGenerator {
    ...
    public boolean interactsWith(int i) {
        int size = this.mOps.size();
        for (int i2 = 0; i2 < size; i2++) {
            Fragment fragment = ((C0172Op) this.mOps.get(i2)).mFragment;
    ...
    public boolean interactsWith(ArrayList<BackStackRecord> arrayList, int i, int i2) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            Fragment fragment = ((C0172Op) this.mOps.get(i4)).mFragment;
            ...
            if (!(i5 == 0 || i5 == i3)) {
                for (int i6 = i; i6 < i2; i6++) {
                    ...
                    for (int i7 = 0; i7 < size2; i7++) {
                        Fragment fragment2 = ((C0172Op) backStackRecord.mOps.get(i7)).mFragment;
            ...
            if (i2 != 1) {
                if (i2 == 2) {
                        ...
                        if (fragment4.mContainerId == i3) {
                            if (fragment4 == fragment3) {
                                ...
                                if (fragment4 == fragment2) {
                                    this.mOps.add(i, new C0172Op(9, fragment4));
                                    i++;
                                    fragment2 = null;
                                }
                                C0172Op op2 = new C0172Op(3, fragment4);
                    ...
                    if (fragment5 == fragment2) {
                        this.mOps.add(i, new C0172Op(9, fragment5));
                        i++;
                        fragment2 = null;
                    }
                } else if (i2 != 7) {
