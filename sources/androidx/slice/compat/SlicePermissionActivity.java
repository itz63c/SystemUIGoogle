...
public class SlicePermissionActivity extends Activity implements OnClickListener, OnDismissListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        try {
            ...
            builder.setNegativeButton(R$string.abc_slice_permission_deny, (OnClickListener) this);
            builder.setPositiveButton(R$string.abc_slice_permission_allow, (OnClickListener) this);
    ...
    private CharSequence loadSafeLabel(PackageManager packageManager, ApplicationInfo applicationInfo) {
        ...
        while (true) {
            ...
            if (type == 13 || type == 15 || type == 14) {
                ...
                if (type == 12) {
                    ...
                    sb.append(" ");
                    sb.append(obj.substring(Character.charCount(codePointAt) + i));
                    obj = sb.toString();
                }
        ...
        return TextUtils.ellipsize(trim, textPaint, 500.0f, TruncateAt.END);
    }
