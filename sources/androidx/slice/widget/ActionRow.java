...
public class ActionRow extends FrameLayout {
    ...
    /* JADX WARNING: type inference failed for: r0v6, types: [boolean] */
    ...
    public void setActions(java.util.List<androidx.slice.core.SliceAction> r6, int r7) {
        ...
        L_0x002e:
            ...
            androidx.slice.SliceItem r3 = androidx.slice.core.SliceQuery.find(r2, r3)
            java.lang.String r4 = "image"
            androidx.slice.SliceItem r2 = androidx.slice.core.SliceQuery.find(r2, r4)
    ...
    private void handleSetRemoteInputActions(final SliceItem sliceItem, SliceItem sliceItem2, final SliceItem sliceItem3) {
        if (sliceItem.getRemoteInput().getAllowFreeFormInput()) {
            addAction(sliceItem2.getIcon(), !sliceItem2.hasHint("no_tint")).setOnClickListener(new OnClickListener() {
    ...
    public boolean handleRemoteInputClick(View view, SliceItem sliceItem, RemoteInput remoteInput) {
        ...
        for (ViewParent parent = view.getParent().getParent(); parent != null; parent = parent.getParent()) {
            if (parent instanceof View) {
                remoteInputView = findRemoteInputView((View) parent);
