...
public class PlaybackSupportFragment extends Fragment {
    ...
    int mBgLightColor;
    final Client mChainedClient = new Client(this) {
    };
    ...
    private final AnimatorListener mFadeListener = new AnimatorListener() {
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            if (verticalGridView != null && verticalGridView.getSelectedPosition() == 0) {
                ViewHolder viewHolder = (ViewHolder) verticalGridView.findViewHolderForAdapterPosition(0);
    ...
    private void loadBgAnimator() {
        C02487 r0 = new AnimatorUpdateListener() {
    ...
    private void loadControlRowAnimator() {
        C02498 r0 = new AnimatorUpdateListener() {
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
    ...
    private void loadOtherRowAnimator() {
        C02509 r0 = new AnimatorUpdateListener() {
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                if (PlaybackSupportFragment.this.getVerticalGridView() != null) {
                    float floatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
        ...
        if (objectAdapter != null && objectAdapter.getPresenterSelector() != null) {
            ...
            if (presenters != null) {
                for (int i = 0; i < presenters.length; i++) {
                    if ((presenters[i] instanceof PlaybackRowPresenter) && presenters[i].getFacet(cls) == null) {
                        ...
                        presenters[i].setFacet(cls, itemAlignmentFacet);
                    }
                }
            }
        }
    ...
    private void setupRow() {
        ...
        if (!(objectAdapter instanceof ArrayObjectAdapter) || this.mRow == null) {
            ...
            if (objectAdapter2 instanceof SparseArrayObjectAdapter) {
                Row row = this.mRow;
                if (row != null) {
