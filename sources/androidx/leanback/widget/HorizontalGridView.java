...
public class HorizontalGridView extends BaseGridView {
    ...
    public final void setFadingLeftEdgeLength(int i) {
        if (this.mLowFadeShaderLength != i) {
            ...
            if (i != 0) {
                LinearGradient linearGradient = new LinearGradient(0.0f, 0.0f, (float) this.mLowFadeShaderLength, 0.0f, 0, -16777216, TileMode.CLAMP);
                this.mLowFadeShader = linearGradient;
            } else {
    ...
    public final void setFadingRightEdgeLength(int i) {
        if (this.mHighFadeShaderLength != i) {
            ...
            if (i != 0) {
                LinearGradient linearGradient = new LinearGradient(0.0f, 0.0f, (float) this.mHighFadeShaderLength, 0.0f, -16777216, 0, TileMode.CLAMP);
                this.mHighFadeShader = linearGradient;
            } else {
