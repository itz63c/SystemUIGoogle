...
abstract class StaggeredGrid extends Grid {
    ...
    public static class Location extends androidx.leanback.widget.Grid.Location {
        public int offset;
        public int size;
    ...
    public final int appendVisibleItemToRow(int i, int i2, int i3) {
        ...
        if (i4 < 0 || (i4 == getLastIndex() && this.mLastVisibleIndex == i - 1)) {
            int i5 = this.mLastVisibleIndex;
            int i6 = i5 < 0 ? (this.mLocations.size() <= 0 || i != getLastIndex() + 1) ? 0 : calculateOffsetAfterLastItem(i2) : i3 - this.mProvider.getEdge(i5);
            Location location = new Location(i2, i6, 0);
