...
public class GuidedActionsStylist {
    ...
    static {
        ...
        sGuidedActionItemAlignFacet.setAlignmentDefs(new ItemAlignmentDef[]{itemAlignmentDef});
    }
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup) {
        ...
        if (view instanceof GuidedActionsRelativeLayout) {
            ((GuidedActionsRelativeLayout) view).setInterceptKeyEventListener(new InterceptKeyEventListener() {
                public boolean onInterceptKeyEvent(KeyEvent keyEvent) {
                    if (keyEvent.getKeyCode() == 4 && keyEvent.getAction() == 1) {
                        GuidedAction guidedAction = GuidedActionsStylist.this.mExpandedAction;
                        if (guidedAction != null && ((guidedAction.hasSubActions() && GuidedActionsStylist.this.isBackKeyToCollapseSubActions()) || (GuidedActionsStylist.this.mExpandedAction.hasEditableActivatorView() && GuidedActionsStylist.this.isBackKeyToCollapseActivatorView()))) {
    ...
    public int onProvideItemLayoutId(int i) {
        ...
        sb.append("ViewType ");
        sb.append(i);
        sb.append(" not supported in GuidedActionsStylist");
    ...
    public void onEditActivatorView(final ViewHolder viewHolder, boolean z, boolean z2) {
        if (z) {
            ...
            viewHolder.mActivatorView.setOnClickListener(new OnClickListener() {
        ...
        if (onUpdateActivatorView(viewHolder, viewHolder.getAction())) {
    ...
    public void expandAction(GuidedAction guidedAction, boolean z) {
        if (!isInExpandTransition() && this.mExpandedAction == null) {
            int indexOf = ((GuidedActionAdapter) getActionsGridView().getAdapter()).indexOf(guidedAction);
            if (indexOf >= 0) {
    ...
    public void onUpdateSubActionsGridView(GuidedAction guidedAction, boolean z) {
        ...
        if (verticalGridView != null) {
            MarginLayoutParams marginLayoutParams = (MarginLayoutParams) verticalGridView.getLayoutParams();
