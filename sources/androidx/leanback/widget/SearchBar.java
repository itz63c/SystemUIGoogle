...
public class SearchBar extends RelativeLayout {
    ...
    public SearchBar(Context context, AttributeSet attributeSet, int i) {
        ...
        LayoutParams layoutParams = new LayoutParams(-1, this.mBarHeight);
    ...
    public void onFinishInflate() {
        ...
        speechOrbView.setOnOrbClickedListener(new OnClickListener() {
    ...
    public void startRecognition() {
        if (!this.mRecognizing) {
            ...
            if (this.mSpeechRecognitionCallback != null) {
                this.mSearchTextEditor.setText(str);
                this.mSearchTextEditor.setHint(str);
                ...
                this.mSpeechRecognizer.setRecognitionListener(new RecognitionListener() {
                    ...
                    public void onResults(Bundle bundle) {
                        ...
                        if (stringArrayList != null) {
                            SearchBar.this.mSearchQuery = (String) stringArrayList.get(0);
                            SearchBar searchBar = SearchBar.this;
                    ...
                    public void onPartialResults(Bundle bundle) {
                        ...
                        if (stringArrayList != null && stringArrayList.size() != 0) {
                            SearchBar.this.mSearchTextEditor.updateRecognizedText((String) stringArrayList.get(0), stringArrayList.size() > 1 ? (String) stringArrayList.get(1) : null);
                        }
                    }
                });
