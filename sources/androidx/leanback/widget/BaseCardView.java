...
public class BaseCardView extends FrameLayout {
    ...
    public void onMeasure(int i, int i2) {
        ...
        for (int i7 = 0; i7 < this.mMainViewList.size(); i7++) {
            View view = (View) this.mMainViewList.get(i7);
        ...
        this.mMeasuredHeight = (int) (((f + f2) + ((float) i3)) - (z ? 0.0f : this.mInfoOffset));
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (hasInfoRegion()) {
            ...
            for (int i6 = 0; i6 < this.mInfoViewList.size(); i6++) {
                f += (float) ((View) this.mInfoViewList.get(i6)).getMeasuredHeight();
            }
    ...
    private void setInfoViewVisibility(boolean z) {
        ...
        if (i == 3) {
            ...
            for (int i5 = 0; i5 < this.mInfoViewList.size(); i5++) {
                ((View) this.mInfoViewList.get(i5)).setVisibility(z ? 0 : 8);
            }
        } else if (i == 1) {
            animateInfoAlpha(z);
        }
