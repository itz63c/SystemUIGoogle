    ...
    class DialogPopup implements SpinnerPopup, OnClickListener {
        ...
        public void show(int i, int i2) {
            if (this.mListAdapter != null) {
                ...
                builder.setSingleChoiceItems(this.mListAdapter, AppCompatSpinner.this.getSelectedItemPosition(), (OnClickListener) this);
        ...
        public void show(int i, int i2) {
            ...
            if (!isShowing) {
                ...
                if (viewTreeObserver != null) {
                    final C00642 r6 = new OnGlobalLayoutListener() {
