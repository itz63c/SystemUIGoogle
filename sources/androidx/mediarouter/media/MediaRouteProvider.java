    ...
    public static abstract class DynamicGroupRouteController extends RouteController {
        ...
        public static final class DynamicRouteDescriptor {
            ...
            static DynamicRouteDescriptor fromBundle(Bundle bundle) {
                ...
                DynamicRouteDescriptor dynamicRouteDescriptor = new DynamicRouteDescriptor(MediaRouteDescriptor.fromBundle(bundle.getBundle("mrDescriptor")), bundle.getInt("selectionState", 1), bundle.getBoolean("isUnselectable", false), bundle.getBoolean("isGroupable", false), bundle.getBoolean("isTransferable", false));
                return dynamicRouteDescriptor;
            }
        }
                ...
                if (executor == null) {
                    ...
                    if (this.mPendingRoutes != null && !this.mPendingRoutes.isEmpty()) {
                        ...
                        this.mExecutor.execute(new Runnable() {
                            public void run() {
                                onDynamicRoutesChangedListener.onRoutesChanged(DynamicGroupRouteController.this, collection);
                            }
                        });
                    }
                } else {
