...
final class RegisteredMediaRouteProvider extends MediaRouteProvider implements ServiceConnection {
    ...
    private final class Connection implements DeathRecipient {
        ...
        public boolean onDynamicRouteDescriptorsChanged(int i, Bundle bundle) {
            ...
            while (it.hasNext()) {
                arrayList.add(DynamicRouteDescriptor.fromBundle((Bundle) it.next()));
            }
        ...
        public int createDynamicGroupRouteController(String str, ControlRequestCallback controlRequestCallback) {
            int i = this.mNextControllerId;
            this.mNextControllerId = i + 1;
            int i2 = this.mNextRequestId;
            this.mNextRequestId = i2 + 1;
    ...
    private final class RegisteredDynamicController extends DynamicGroupRouteController implements ControllerConnection {
        ...
        public void attachConnection(Connection connection) {
            C03781 r0 = new ControlRequestCallback() {
        ...
        /* access modifiers changed from: 0000 */
        public void onDynamicRoutesChanged(List<DynamicRouteDescriptor> list) {
    ...
    private boolean shouldBind() {
        if (!this.mStarted || (getDiscoveryRequest() == null && this.mControllerConnections.isEmpty())) {
            return false;
        }
        return true;
    }
    ...
    private DynamicGroupRouteController createDynamicGroupRouteController(String str) {
        MediaRouteProviderDescriptor descriptor = getDescriptor();
        if (descriptor != null) {
            List routes = descriptor.getRoutes();
            int size = routes.size();
    ...
    /* access modifiers changed from: 0000 */
    public void onDynamicRouteDescriptorChanged(Connection connection, int i, List<DynamicRouteDescriptor> list) {
        if (this.mActiveConnection == connection) {
            if (DEBUG) {
                StringBuilder sb = new StringBuilder();
                sb.append(this);
