...
public class MediaRouteButton extends View {
    ...
    private final class RemoteIndicatorLoader extends AsyncTask<Void, Void, Drawable> {
        ...
        public Drawable doInBackground(Void... voidArr) {
            if (((ConstantState) MediaRouteButton.sRemoteIndicatorCache.get(this.mResId)) == null) {
        ...
        public void onPostExecute(Drawable drawable) {
            if (drawable != null) {
                ...
                ConstantState constantState = (ConstantState) MediaRouteButton.sRemoteIndicatorCache.get(this.mResId);
    ...
    public MediaRouteButton(Context context, AttributeSet attributeSet, int i) {
        ...
        if (i2 != 0) {
            ConstantState constantState = (ConstantState) sRemoteIndicatorCache.get(i2);
            if (constantState != null) {
        ...
        if (this.mRemoteIndicator == null) {
            if (resourceId != 0) {
                ConstantState constantState2 = (ConstantState) sRemoteIndicatorCache.get(resourceId);
    ...
    public boolean showDialog() {
        ...
        if (fragmentManager != null) {
            ...
            if (selectedRoute.isDefaultOrBluetooth() || !selectedRoute.matchesSelector(this.mSelector)) {
                ...
                beginTransaction.add(onCreateChooserDialogFragment, str2);
                ...
                beginTransaction2.add(onCreateControllerDialogFragment, str3);
