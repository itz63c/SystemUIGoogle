...
public class TypefaceCompatApi26Impl extends TypefaceCompatApi21Impl {
    ...
    public android.graphics.Typeface createFromFontInfo(android.content.Context r11, android.os.CancellationSignal r12, androidx.core.provider.FontsContractCompat.FontInfo[] r13, int r14) {
        ...
        L_0x0006:
            ...
            android.net.Uri r13 = r10.getUri()     // Catch:{ IOException -> 0x0057 }
            java.lang.String r14 = "r"
            android.os.ParcelFileDescriptor r11 = r11.openFileDescriptor(r13, r14, r12)     // Catch:{ IOException -> 0x0057 }
        ...
        L_0x0026:
            ...
            java.io.FileDescriptor r13 = r11.getFileDescriptor()     // Catch:{ all -> 0x0049 }
            r12.<init>(r13)     // Catch:{ all -> 0x0049 }
            int r13 = r10.getWeight()     // Catch:{ all -> 0x0049 }
            android.graphics.Typeface$Builder r12 = r12.setWeight(r13)     // Catch:{ all -> 0x0049 }
            boolean r10 = r10.isItalic()     // Catch:{ all -> 0x0049 }
            android.graphics.Typeface$Builder r10 = r12.setItalic(r10)     // Catch:{ all -> 0x0049 }
        ...
        L_0x0052:
            r11 = move-exception
            r10.addSuppressed(r11)     // Catch:{ IOException -> 0x0057 }
        L_0x0056:
            throw r12     // Catch:{ IOException -> 0x0057 }
        L_0x0057:
            return r2
        L_0x0058:
