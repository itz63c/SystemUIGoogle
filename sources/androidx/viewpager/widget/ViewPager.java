        ...
        while (true) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams != null && layoutParams.isDecor) {
                    ...
                    childAt.measure(MeasureSpec.makeMeasureSpec(i10, i9), MeasureSpec.makeMeasureSpec(i11, i5));
                    if (z2) {
        ...
        for (int i12 = 0; i12 < childCount2; i12++) {
            ...
            if (childAt2.getVisibility() != 8) {
                ...
                if (layoutParams2 == null || !layoutParams2.isDecor) {
                    childAt2.measure(MeasureSpec.makeMeasureSpec((int) (((float) paddingLeft) * layoutParams2.widthFactor), 1073741824), makeMeasureSpec);
                }
            }
        }
    }
