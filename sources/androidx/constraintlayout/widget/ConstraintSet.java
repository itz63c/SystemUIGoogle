        ...
        for (int i = 0; i < indexCount; i++) {
            ...
            switch (i2) {
                ...
                default:
                    ...
                    switch (i2) {
                        case R$styleable.ConstraintSet_layout_constraintWidth_default /*60*/:
                            constraint.rotation = typedArray.getFloat(index, constraint.rotation);
                            break;
                        case R$styleable.ConstraintSet_layout_constraintWidth_max /*61*/:
                            constraint.circleConstraint = lookupID(typedArray, index, constraint.circleConstraint);
                            break;
                        case R$styleable.ConstraintSet_layout_constraintWidth_min /*62*/:
