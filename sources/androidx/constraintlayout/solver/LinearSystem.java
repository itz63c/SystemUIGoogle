...
public class LinearSystem {
    ...
    private int enforceBFS(Row row) throws Exception {
        ...
        while (true) {
            ...
            ArrayRow[] arrayRowArr = this.mRows;
            if (arrayRowArr[i].variable.mType != Type.UNRESTRICTED && arrayRowArr[i].constantValue < 0.0f) {
                z = true;
                break;
            }
            i++;
    ...
    public static ArrayRow createRowDimensionPercent(LinearSystem linearSystem, SolverVariable solverVariable, SolverVariable solverVariable2, SolverVariable solverVariable3, float f, boolean z) {
        ...
        createRow.createRowDimensionPercent(solverVariable, solverVariable2, solverVariable3, f);
        return createRow;
    }
