...
class CircleImageView extends ImageView {
    ...
    private static class OvalShadow extends OvalShape {
        ...
        private void updateRadialGradient(int i) {
            ...
            float f = (float) (i / 2);
            RadialGradient radialGradient = new RadialGradient(f, f, (float) this.mShadowRadius, new int[]{1023410176, 0}, null, TileMode.CLAMP);
    ...
    CircleImageView(Context context) {
        ...
        this.mBackgroundColor = obtainStyledAttributes.getColor(R$styleable.f19xaa980688, -328966);
