...
public class RecyclerView extends ViewGroup implements NestedScrollingChild {
    ...
    static /* synthetic */ class C04377 {
        ...
        /* renamed from: $SwitchMap$androidx$recyclerview$widget$RecyclerView$Adapter$StateRestorationStrategy */
        static final /* synthetic */ int[] f18x8485c69a;
        ...
        static {
            /*
                androidx.recyclerview.widget.RecyclerView$Adapter$StateRestorationStrategy[] r0 = androidx.recyclerview.widget.RecyclerView.Adapter.StateRestorationStrategy.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                f18x8485c69a = r0
                androidx.recyclerview.widget.RecyclerView$Adapter$StateRestorationStrategy r1 = androidx.recyclerview.widget.RecyclerView.Adapter.StateRestorationStrategy.PREVENT     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                int[] r0 = f18x8485c69a     // Catch:{ NoSuchFieldError -> 0x001d }
                androidx.recyclerview.widget.RecyclerView$Adapter$StateRestorationStrategy r1 = androidx.recyclerview.widget.RecyclerView.Adapter.StateRestorationStrategy.PREVENT_WHEN_EMPTY     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.recyclerview.widget.RecyclerView.C04377.<clinit>():void");
        }
    }
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        public boolean canRestoreState() {
            int i = C04377.f18x8485c69a[this.mStateRestorationStrategy.ordinal()];
            boolean z = false;
            if (i != 1) {
                if (i != 2) {
                    return true;
