...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
            ...
            if (actionMasked == 0) {
                ...
                if (itemTouchHelper.mSelected == null) {
                    ...
                    if (findAnimation != null) {
                        ...
                        itemTouchHelper2.mInitialTouchX -= findAnimation.f16mX;
                        itemTouchHelper2.mInitialTouchY -= findAnimation.f17mY;
    ...
    public static abstract class Callback {
        ...
        public abstract boolean canDropOver(RecyclerView recyclerView, ViewHolder viewHolder, ViewHolder viewHolder2);
        ...
        public void onDraw(Canvas canvas, RecyclerView recyclerView, ViewHolder viewHolder, List<RecoverAnimation> list, int i, float f, float f2) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                onChildDraw(canvas, recyclerView, recoverAnimation.mViewHolder, recoverAnimation.f16mX, recoverAnimation.f17mY, recoverAnimation.mActionState, false);
        ...
        public void onDrawOver(Canvas canvas, RecyclerView recyclerView, ViewHolder viewHolder, List<RecoverAnimation> list, int i, float f, float f2) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                int save = canvas.save();
                onChildDrawOver(canvas, recyclerView, recoverAnimation.mViewHolder, recoverAnimation.f16mX, recoverAnimation.f17mY, recoverAnimation.mActionState, false);
                canvas.restoreToCount(save);
            }
            if (viewHolder != null) {
                int save2 = canvas.save();
    ...
    static class RecoverAnimation implements AnimatorListener {
        ...
        public void update() {
            ...
            if (f == f2) {
                this.f16mX = this.mViewHolder.itemView.getTranslationX();
            } else {
                this.f16mX = f + (this.mFraction * (f2 - f));
            }
            float f3 = this.mStartDy;
            float f4 = this.mTargetY;
            if (f3 == f4) {
                this.f17mY = this.mViewHolder.itemView.getTranslationY();
            } else {
                this.f17mY = f3 + (this.mFraction * (f4 - f3));
            }
        }
    ...
    public View findChildView(MotionEvent motionEvent) {
        ...
        for (int size = this.mRecoverAnimations.size() - 1; size >= 0; size--) {
            ...
            if (hitTest(view2, x, y, recoverAnimation.f16mX, recoverAnimation.f17mY)) {
                return view2;
            }
        }
