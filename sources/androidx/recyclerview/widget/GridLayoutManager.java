    ...
    public void layoutChunk(Recycler recycler, State state, LayoutState layoutState, LayoutChunkResult layoutChunkResult) {
        ...
        for (int i18 = 0; i18 < i13; i18++) {
            ...
            if (this.mOrientationHelper.getDecoratedMeasurement(view3) != i16) {
                ...
                if (this.mOrientation == 1) {
                    i10 = LayoutManager.getChildMeasureSpec(spaceForSpanRange, 1073741824, i20, layoutParams.width, false);
                    i9 = MeasureSpec.makeMeasureSpec(i16 - i19, 1073741824);
                } else {
                    int makeMeasureSpec = MeasureSpec.makeMeasureSpec(i16 - i20, 1073741824);
                    i9 = LayoutManager.getChildMeasureSpec(spaceForSpanRange, 1073741824, i19, layoutParams.height, false);
                    i10 = makeMeasureSpec;
                }
