...
public final class ViewPager2 extends ViewGroup {
    ...
    class PageAwareAccessibilityProvider extends AccessibilityProvider {
        ...
        private void addCollectionInfo(AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
            ...
            accessibilityNodeInfoCompat.setCollectionInfo(CollectionInfoCompat.obtain(i2, i, false, 0));
        }
    ...
    private void initialize(Context context, AttributeSet attributeSet) {
        ...
        C05012 r3 = new OnPageChangeCallback() {
            public void onPageSelected(int i) {
                ViewPager2 viewPager2 = ViewPager2.this;
        ...
        C05023 r4 = new OnPageChangeCallback() {
            public void onPageSelected(int i) {
    ...
    private OnChildAttachStateChangeListener enforceChildFillListener() {
        return new OnChildAttachStateChangeListener(this) {
